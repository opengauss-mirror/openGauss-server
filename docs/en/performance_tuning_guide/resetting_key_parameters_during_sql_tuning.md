...
This section introduces key parameters of the primary database node that affect optimization of SQL statements in openGauss. For details about the parameter configurations, see  [Configuring Running Parameters](https://docs.opengauss.org/en/docs/latest/database_administration_guide/viewing_parameter_values.html).
