...
系统配置文件`pg_hba.conf`内各种参数出现异常导致的启动或重启集群失败。具体参数说明参考[配置文件参考](https://docs.opengauss.org/zh/docs/latest/database_administration_guide/configuration_file_reference.html)。
