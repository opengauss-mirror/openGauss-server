...
请按照[MOT部署](https://docs.opengauss.org/zh/docs/latest/database_administration_guide/mot_server_optimization.html)中的说明进行操作。下面介绍openGauss数据库在华为TaiShan服务器和Euler 2.8操作系统上部署时系统级的关键优化点，以达到极致性能。
