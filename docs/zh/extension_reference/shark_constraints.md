...
- 本章节只包含shark新增的语法，原openGauss的语法未做删除和修改。原openGauss请参考章节[约束](https://docs.opengauss.org/zh/docs/latest/sql_reference/constraints.html)。
...
[约束](https://docs.opengauss.org/zh/docs/latest/sql_reference/constraints.html)
