...
- 本章节只包含shark新增的语法，原openGauss的语法未做删除和修改。原openGauss的CREATE PROCEDURE语法请参考章节[CREATE PROCEDURE](https://docs.opengauss.org/zh/docs/latest/sql_reference/create_procedure.html)。
...
[CREATE PROCEDURE](https://docs.opengauss.org/zh/docs/latest/sql_reference/create_procedure.html)
