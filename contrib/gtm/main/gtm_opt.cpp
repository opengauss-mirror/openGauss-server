...
struct config_bool ConfigureNamesBool[] = {
    {{GTM_OPTNAME_SYNCHRONOUS_BACKUP,
         GTMC_STARTUP,
...
struct config_int ConfigureNamesInt[] = {
    {{GTM_OPTNAME_PORT, GTMC_STARTUP, gettext_noop("Listen Port of GTM or GTM standby server."), NULL, 0},
        &GTMPortNumber,
        6666,
        0,
        INT_MAX,
...
struct config_string ConfigureNamesString[] = {
    {{GTM_OPTNAME_DATA_DIR, GTMC_STARTUP, gettext_noop("Work directory."), NULL, 0}, &GTMDataDir, NULL, NULL, NULL},
    ...
    {{GTM_OPTNAME_NODENAME, GTMC_STARTUP, gettext_noop("Name of this GTM/GTM-Standby."), NULL, 0},
        &NodeName,
        "",
        NULL,
        NULL},
    ...
    {{GTM_OPTNAME_LOG_FILE, GTMC_SIGHUP, gettext_noop("Log file name."), NULL, 0}, &GTMLogFile, "gtm.log", NULL, NULL},
...
struct config_enum ConfigureNamesEnum[] = {{{GTM_OPTNAME_LOG_MIN_MESSAGES,
    ...
    {{GTM_OPTNAME_STARTUP, GTMC_SIGHUP, gettext_noop("Specifies startup mode, act or standby."), NULL, 0},
        &GTM_StandbyMode,
        GTM_ACT_MODE,
        gtm_startup_mode_options,
        GTM_ACT_MODE,
