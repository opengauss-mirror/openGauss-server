...
sigset_t UnBlockSig, BlockSig, AuthBlockSig;
#else
int UnBlockSig, BlockSig, AuthBlockSig;
#endif
...
/* Signals unique to Auth */
    ...
    BlockSig = sigmask(SIGQUIT) | sigmask(SIGTERM) | sigmask(SIGALRM) |
               ...
               sigmask(SIGHUP) | sigmask(SIGINT) | sigmask(SIGUSR1) | sigmask(SIGUSR2) | sigmask(SIGCHLD) |
               sigmask(SIGWINCH) | sigmask(SIGFPE);
    AuthBlockSig = sigmask(SIGHUP) | sigmask(SIGINT) | sigmask(SIGUSR1) | sigmask(SIGUSR2) | sigmask(SIGCHLD) |
                   sigmask(SIGWINCH) | sigmask(SIGFPE);
#endif
}
