...
struct config_int ConfigureNamesInt[] = {
    {{GTM_OPTNAME_PORT, GTMC_STARTUP, gettext_noop("Listen Port of GTM_Proxy server."), NULL, 0},
        &GTMProxyPortNumber,
        6666,
        0,
        INT_MAX,
        0,
        NULL},
    {{GTM_OPTNAME_GTM_PORT, GTMC_SIGHUP, gettext_noop("GTM server port number."), NULL, 0},
        &GTMServerPortNumber,
        6666,
        0,
        INT_MAX,
        0,
        NULL},
    {{GTM_OPTNAME_CONNECT_RETRY_INTERVAL,
         GTMC_SIGHUP,
    ...
    {{GTM_OPTNAME_KEEPALIVES_IDLE,
        ...
        0,
        NULL},
    {{GTM_OPTNAME_KEEPALIVES_INTERVAL,
         GTMC_STARTUP,
    ...
    {{GTM_OPTNAME_KEEPALIVES_COUNT,
        ...
        0,
        NULL},
    {{GTM_OPTNAME_WORKER_THREADS, GTMC_STARTUP, gettext_noop("Number of worker thread."), NULL, 0},
        &GTMProxyWorkerThreads,
        GTM_PROXY_DEFAULT_WORKERS,
        1,
        INT_MAX,
        0,
        NULL},
...
struct config_string ConfigureNamesString[] = {
    {{GTM_OPTNAME_DATA_DIR, GTMC_STARTUP, gettext_noop("Work directory."), NULL, 0},
        &GTMProxyDataDir,
        NULL,
        NULL,
        NULL},

    {{GTM_OPTNAME_CONFIG_FILE, GTMC_SIGHUP, gettext_noop("Configuration file name."), NULL, 0},
        &GTMConfigFileName,
        CONFIG_FILENAME,
        NULL,
        NULL},

    {{GTM_OPTNAME_LISTEN_ADDRESSES, GTMC_STARTUP, gettext_noop("Listen address."), NULL, 0},
        &ListenAddresses,
        "*",
        NULL,
        NULL},
    ...
    {{GTM_OPTNAME_GTM_HOST, GTMC_SIGHUP, gettext_noop("Address of target GTM ACT."), NULL, 0},
        &GTMServerHost,
        NULL,
        NULL,
        NULL},

    {{GTM_OPTNAME_LOG_FILE, GTMC_SIGHUP, gettext_noop("Log file name."), NULL, 0},
        &GTMLogFile,
        "gtm_proxy.log",
        NULL,
        NULL},

    {{GTM_OPTNAME_ERROR_REPORTER, GTMC_SIGHUP, gettext_noop("Command to report various errors."), NULL, 0},
        &error_reporter,
        NULL,
        NULL,
        NULL},

    {{GTM_OPTNAME_STATUS_READER,
         GTMC_SIGHUP,
...
struct config_enum ConfigureNamesEnum[] = {{{GTM_OPTNAME_LOG_MIN_MESSAGES,
                                                GTMC_SIGHUP,
