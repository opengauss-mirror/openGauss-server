 ...
 */
PQExpBuffer createGTMPQExpBuffer(void)
{
    PQExpBuffer res;
 ...
 */
void initGTMPQExpBuffer(PQExpBuffer str)
{
 ...
 */
void destroyGTMPQExpBuffer(PQExpBuffer str)
{
    if (str) {
 ...
 */
void termGTMPQExpBuffer(PQExpBuffer str)
{
    if (str->data != oom_buffer) {
        free(str->data);
    }
 ...
 */
void resetGTMPQExpBuffer(PQExpBuffer str)
{
    if (str) {
 ...
 */
int enlargeGTMPQExpBuffer(PQExpBuffer str, size_t needed)
{
    size_t newlen;
    char* newdata;
 ...
 */
void printfGTMPQExpBuffer(PQExpBuffer str, const char* fmt, ...)
{
    va_list args;
    size_t avail;
    int nprinted;
    ...
    for (;;) {
        ...
        if (str->maxlen > str->len + 16) {
            ...
            va_start(args, fmt);
            nprinted = vsnprintf_s(str->data + str->len, avail, avail - 1, fmt, args);
 ...
 * strcat.
 */
void appendGTMPQExpBuffer(PQExpBuffer str, const char* fmt, ...)
{
    va_list args;
    size_t avail;
    int nprinted;
 ...
 * if necessary.
 */
void appendGTMPQExpBufferStr(PQExpBuffer str, const char* data)
{
 ...
 */
void appendGTMPQExpBufferChar(PQExpBuffer str, char ch)
{
 ...
 * if necessary.
 */
void appendBinaryGTMPQExpBuffer(PQExpBuffer str, const char* data, size_t datalen)
{
    errno_t rc = EOK;
    /* Make more room if needed */
    ...
    /* OK, append the data */
    rc = memcpy_s(str->data + str->len, datalen, data, datalen);
