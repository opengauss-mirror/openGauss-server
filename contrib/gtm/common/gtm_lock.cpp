 ...
 */
bool GTM_RWLockAcquire(GTM_RWLock* lock, GTM_LockMode mode)
{
    int status = EINVAL;
 ...
 */
bool GTM_RWLockRelease(GTM_RWLock* lock)
{
    int status;
 ...
 * Initialize a lock
 */
int GTM_RWLockInit(GTM_RWLock* lock)
{
 ...
 * Destroy a lock
 */
int GTM_RWLockDestroy(GTM_RWLock* lock)
{
 ...
 */
bool GTM_RWLockConditionalAcquire(GTM_RWLock* lock, GTM_LockMode mode)
{
    int status = EINVAL;
 ...
 */
int GTM_MutexLockInit(GTM_MutexLock* lock)
{
 ...
 */
int GTM_MutexLockDestroy(GTM_MutexLock* lock)
{
 ...
 */
bool GTM_MutexLockAcquire(GTM_MutexLock* lock)
{
 ...
 * Release previously acquired lock
 */
bool GTM_MutexLockRelease(GTM_MutexLock* lock)
{
 ...
 * Returns true if lock is successfully acquired. Otherwise returns false
 */
bool GTM_MutexLockConditionalAcquire(GTM_MutexLock* lock)
{
 ...
 * already.
 */
int GTM_CVWait(GTM_CV* cv, GTM_MutexLock* lock)
{
