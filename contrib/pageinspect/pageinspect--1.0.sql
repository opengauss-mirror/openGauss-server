...
-- page_compress_meta
--
CREATE FUNCTION page_compress_meta(IN relation_name bytea,
    IN blkno int4,
	IN blknum int4,
    OUT compress_meta text)
AS 'MODULE_PATHNAME', 'page_compress_meta'
LANGUAGE C STRICT;

CREATE FUNCTION page_compress_meta_usage(
    OUT help text)
AS 'MODULE_PATHNAME', 'page_compress_meta_usage'
LANGUAGE C STRICT;
