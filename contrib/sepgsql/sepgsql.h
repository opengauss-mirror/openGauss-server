...
extern void sepgsql_audit_log(
    bool denied, const char* scontext, const char* tcontext, uint16 tclass, uint32 audited, const char* audit_name);

extern void sepgsql_compute_avd(const char* scontext, const char* tcontext, uint16 tclass, struct av_decision* avd);

extern char* sepgsql_compute_create(const char* scontext, const char* tcontext, uint16 tclass);

extern bool sepgsql_check_perms(
...
extern void sepgsql_object_relabel(const ObjectAddress* object, const char* seclabel);
 ...
 * database.c
 */
extern void sepgsql_database_post_create(Oid databaseId, const char* dtemplate);
...
extern void sepgsql_attribute_relabel(Oid relOid, AttrNumber attnum, const char* seclabel);
