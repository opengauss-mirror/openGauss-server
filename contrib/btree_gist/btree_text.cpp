...
extern "C" Datum gbt_text_compress(PG_FUNCTION_ARGS);
extern "C" Datum gbt_bpchar_compress(PG_FUNCTION_ARGS);
extern "C" Datum gbt_text_union(PG_FUNCTION_ARGS);
extern "C" Datum gbt_text_picksplit(PG_FUNCTION_ARGS);
extern "C" Datum gbt_text_consistent(PG_FUNCTION_ARGS);
extern "C" Datum gbt_bpchar_consistent(PG_FUNCTION_ARGS);
extern "C" Datum gbt_text_penalty(PG_FUNCTION_ARGS);
extern "C" Datum gbt_text_same(PG_FUNCTION_ARGS);

/* define for comparison */

static bool gbt_textgt(const void* a, const void* b, Oid collation)
{
    return DatumGetBool(DirectFunctionCall2Coll(text_gt, collation, PointerGetDatum(a), PointerGetDatum(b)));
}

static bool gbt_textge(const void* a, const void* b, Oid collation)
{
    return DatumGetBool(DirectFunctionCall2Coll(text_ge, collation, PointerGetDatum(a), PointerGetDatum(b)));
}

static bool gbt_texteq(const void* a, const void* b, Oid collation)
{
    return DatumGetBool(DirectFunctionCall2Coll(texteq, collation, PointerGetDatum(a), PointerGetDatum(b)));
}

static bool gbt_textle(const void* a, const void* b, Oid collation)
{
    return DatumGetBool(DirectFunctionCall2Coll(text_le, collation, PointerGetDatum(a), PointerGetDatum(b)));
}

static bool gbt_textlt(const void* a, const void* b, Oid collation)
{
    return DatumGetBool(DirectFunctionCall2Coll(text_lt, collation, PointerGetDatum(a), PointerGetDatum(b)));
}

static int32 gbt_textcmp(const void* a, const void* b, Oid collation)
{
