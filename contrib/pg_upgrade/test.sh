...
# GaussDb uses very different program names for $oldbindir/*. And i think the
# simplest solution is to get copies and rename them.
cp $oldbindir/gs_clean $oldbindir/pg_clean
cp $oldbindir/gs_ctl  $oldbindir/pg_ctl
cp $oldbindir/gaussdb $oldbindir/postgres
cp $oldbindir/gs_dump $oldbindir/pg_dump
cp $oldbindir/gs_dumpall $oldbindir/pg_dumpall 
cp $oldbindir/gs_gtm $oldbindir/gtm
cp $oldbindir/gs_initdb $oldbindir/initdb
cp $oldbindir/gs_initgtm $oldbindir/initgtm
cp $oldbindir/gsql $oldbindir/psql
