...
#define ddl_commands_fmgrinfo (get_session_context()->tsdb_ddl_commands_fmgrinfo)
#define dropped_objects_fmgrinfo (get_session_context()->tsdb_dropped_objects_fmgrinfo)
#define extension_proxy_oid (get_session_context()->tsdb_extension_proxy_oid)
#define downgrade_to_apache_enabled (get_session_context()->tsdb_downgrade_to_apache_enabled)
#define tsl_handle (get_session_context()->tsdb_tsl_handle)
#define tsl_validate_license_fn (get_session_context()->tsdb_tsl_validate_license_fn)
...
#define dsm_control_mapped_size (get_session_context()->tsdb_dsm_control_mapped_size)
#define dsm_control_impl_private (get_session_context()->tsdb_dsm_control_impl_private)
...
#if PG11_LT
#define ResultRelInfo_OnConflictProjInfoCompat(rri) (rri)->ri_updateProj
#define ResultRelInfo_OnConflictWhereCompat(rri) (rri)->ri_updateWhere
