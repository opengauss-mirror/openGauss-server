...
Gen_Alloc genAlloc_class = {(void* (*)(void*, size_t))memCxtAlloc,
    (void* (*)(void*, size_t))memCxtAlloc0,
    (void* (*)(void*, size_t))memCxtRealloc,
    (void (*)(void*))memCxtFree,
    (void* (*)())memCxtCurrentContext,
    (void* (*)(size_t))memCxtAllocTop};
