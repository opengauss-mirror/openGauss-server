...
ALTER EXTENSION gsredistribute ADD function pg_get_redis_rel_end_ctid(text,text);
ALTER EXTENSION gsredistribute ADD function pg_get_redis_rel_start_ctid(text,text);
