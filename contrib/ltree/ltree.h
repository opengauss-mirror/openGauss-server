...
extern "C" Datum ltree_isparent(PG_FUNCTION_ARGS);
extern "C" Datum ltree_risparent(PG_FUNCTION_ARGS);
...
extern "C" Datum ltxtq_exec(PG_FUNCTION_ARGS);
extern "C" Datum ltxtq_rexec(PG_FUNCTION_ARGS);
extern "C" Datum _ltq_regex(PG_FUNCTION_ARGS);
extern "C" Datum _ltq_rregex(PG_FUNCTION_ARGS);
extern "C" Datum _lt_q_regex(PG_FUNCTION_ARGS);
extern "C" Datum _lt_q_rregex(PG_FUNCTION_ARGS);
extern "C" Datum _ltxtq_exec(PG_FUNCTION_ARGS);
extern "C" Datum _ltxtq_rexec(PG_FUNCTION_ARGS);
extern "C" Datum _ltree_isparent(PG_FUNCTION_ARGS);
extern "C" Datum _ltree_risparent(PG_FUNCTION_ARGS);
