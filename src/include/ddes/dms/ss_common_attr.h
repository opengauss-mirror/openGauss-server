...
#else
#define ENABLE_UB (g_instance.attr.attr_storage.dms_attr.enable_ub && \
...
typedef enum SSPageReadCancelCause {
    SS_PAGE_READ_CANCEL_NONE = 0,
    SS_PAGE_READ_CANCEL_SEG_META,
    SS_PAGE_READ_CANCEL_DATA_PAGE
} SSPageReadCancelCause;

typedef enum SSPageReadCancelPoint {
    SS_PAGE_READ_CANCEL_POINT_UNKNOWN = 0,
    SS_PAGE_READ_CANCEL_POINT_DMS_READ_REPAIR,
    SS_PAGE_READ_CANCEL_POINT_BUFFER_ALLOC_DMS_RELEASE,
    ...
    SS_PAGE_READ_CANCEL_POINT_SEG_FAST_IO_GUARD,
    SS_PAGE_READ_CANCEL_POINT_SEG_BUFFER_ALLOC_DMS_RELEASE
} SSPageReadCancelPoint;
