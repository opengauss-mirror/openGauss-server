...
enum en_errno_dms_dcs {
    ...
    ERRNO_DMS_DCS_REFORM_VISIT_RES = 11016,
    ERRNO_DMS_DCS_GET_DISK_LSN_FAILED = 11017,
    /* add new errno above */
    ERRNO_DMS_DCS_END
};
...
enum en_errno_dms_drc {
    ...
    ERRNO_DMS_DRC_LOCK_MASTER_NOT_FOUND = 13014,
...
enum en_errno_dms_cb {
    ...
    ERRNO_DMS_CALLBACK_FLUSH_COPY = 16013,
    ERRNO_DMS_CALLBACK_GET_TXN_INFO = 16014,
...
enum en_errno_dms_reform {
    ...
    ERRNO_DMS_REFORM_LMODE_VLDT_PANIC = 17010,
    ERRNO_DMS_REFORM_LSN_VLDT_PANIC = 17011,
