...
extern const size_t GSFS_PREFIX_LEN;
extern const size_t GSFSS_PREFIX_LEN;
extern const size_t LOCAL_PREFIX_LEN;
extern const size_t ROACH_PREFIX_LEN;
extern const size_t GSOBS_PREFIX_LEN;
