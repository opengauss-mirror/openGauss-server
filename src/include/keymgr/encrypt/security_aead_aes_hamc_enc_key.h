 ...
 * -------------------------------------------------------------------------
 *
 * security_aead_aes_hamc_enc_key.h
 *
 * IDENTIFICATION
 *	  src/gausskernel/security/keymgr/include/encrypt/security_aead_aes_hamc_enc_key.h
 *
 * -------------------------------------------------------------------------
 */
...
public:
    ...
    EVP_CIPHER_CTX *encrypt_ctx; /* store encrypt ctx to reuse EVP_CIPHER_CTX */
    EVP_CIPHER_CTX *decrypt_ctx; /* store encrypt ctx to reuse EVP_CIPHER_CTX */
