...
extern IndexScanDesc index_beginscan(Relation heapRelation, Relation indexRelation, Snapshot snapshot, int nkeys,
                                     int norderbys, ScanState* scan_state = NULL, ParallelIndexScanDesc pscan = NULL,
                                     int dop = 1, int nodeid = -1);
...
extern void index_rescan(IndexScanDesc scan, ScanKey keys, int nkeys, ScanKey orderbys, int norderbys, int dop = 1,
                         int plan_nodeid = -1);
