...
extern RewriteState begin_heap_rewrite(
...
//
extern MemoryContext get_heap_rewrite_memcxt(RewriteState state);
extern bool use_heap_rewrite_memcxt(RewriteState state);
extern void RewriteAndCompressTup(RewriteState state, HeapTuple old_tuple, HeapTuple new_tuple);
/*
 ...
 * ---
 */
#define LOGICAL_REWRITE_FORMAT "map-%x-%x-%X_%X-%lx-%lx"
