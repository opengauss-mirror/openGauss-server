...
extern void pg_reg_getoutarcs(const regex_t *regex, int st, regex_arc_t *arcs, int arcs_len);
...
extern void pg_reg_getcharacters(const regex_t *regex, int co, pg_wchar *chars, int chars_len);
