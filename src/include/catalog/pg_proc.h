...
#define FLOAT42CASHFUNCOID 3910
#define FLOAT82CASHFUNCOID 3911
...
#define TIMETOCHARFUNCOID 9757
#define TIMETZTOCHARFUNCOID 9758
...
#define TIMESTAMPTIMEZONEEXTRACTFUNCOID 2060
#define TIMESTAMPTZTIMEZONEEXTRACTFUNCOID 2061
#define INTERVALTIMEZONEEXTRACTFUNCOID 2062
#define TIMETIMEZONEEXTRACTFUNCOID 2063
#define TIMETZTIMEZONEEXTRACTFUNCOID 2064
#define DEFAULTFORMATTIMESTAMP2CHARFUNCOID 3808
#define DEFAULTFORMATTIMESTAMPTZ2CHARFUNCOID 3813
#define TIMESTAMP2CHARNLSPARAMFUNCOID 6551
#define TIMESTAMPZ2CHARNLSPARAMFUNCOID 6552
#define INTERVAL2CHARNLSPARAMFUNCOID 6553
#define BLOB2CHARFUNCOID 9753
#define BLOB2CHARDEFAULTFUNCOID 9754
#define UNKNOWN2CHAR2FUNCOID 9756
...
#define PROKIND_PIPELINED   'i'
#define PROKIND_SUBFUNCTION 'v'
#define PROKIND_SUBPROCEDURE 'b'
#define PROKIND_UNKNOWN     'u'

#define PROC_IS_FUNC(prokind)   ((prokind) == PROKIND_FUNCTION || (prokind) == PROKIND_SUBFUNCTION)
#define PROC_IS_AGG(prokind)    ((prokind) == PROKIND_AGGREGATE)
#define PROC_IS_WIN(prokind)    ((prokind) == PROKIND_WINDOW)
#define PROC_IS_PRO(prokind)    ((prokind) == PROKIND_PROCEDURE || (prokind) == PROKIND_SUBPROCEDURE)
#define PROC_IS_PIPELINED(prokind)    ((prokind) == PROKIND_PIPELINED)
