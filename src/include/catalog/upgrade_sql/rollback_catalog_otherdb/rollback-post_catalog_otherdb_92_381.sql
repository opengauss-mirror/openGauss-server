...
DROP FUNCTION IF EXISTS pg_catalog.gs_set_obs_file_context(cstring, cstring, cstring) cascade;
DROP FUNCTION IF EXISTS pg_catalog.gs_upload_obs_file(cstring, cstring, cstring) cascade;