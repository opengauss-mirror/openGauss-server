...
CREATE OR REPLACE FUNCTION pg_catalog.pg_user_iostat(OUT userid oid, OUT min_curr_iops integer, OUT max_curr_iops integer, OUT min_peak_iops integer, OUT max_peak_iops integer, OUT io_limits integer, OUT io_priority text) RETURNS SETOF RECORD LANGUAGE INTERNAL as 'pg_stat_get_wlm_user_iostat_info';
...
CREATE OR REPLACE FUNCTION pg_catalog.pg_stat_get_wlm_session_iostat_info(IN unuseattr integer, OUT threadid bigint, OUT maxcurr_iops integer, OUT mincurr_iops integer, OUT maxpeak_iops integer, OUT minpeak_iops integer, OUT iops_limits integer, OUT io_priority integer) RETURNS SETOF RECORD LANGUAGE INTERNAL as 'pg_stat_get_wlm_session_iostat_info';
