...
RETURNS text LANGUAGE INTERNAL STABLE NOT FENCED NOT SHIPPABLE AS 'aes_encrypt';
...
RETURNS text LANGUAGE INTERNAL STABLE NOT FENCED NOT SHIPPABLE AS 'aes_decrypt';
