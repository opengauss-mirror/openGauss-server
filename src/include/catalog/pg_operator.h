...
DESCR("equal");
DATA(insert OID = 353 ("="       PGNSP PGUID b f f    28    20    16     0     0 xideqint8 eqsel eqjoinsel));
DESCR("equal");
DATA(insert OID = 354 ("<"       PGNSP PGUID b f f    28    28    16     0     0 xidlt neqsel neqjoinsel));
DESCR("less than");
DATA(insert OID = 355 ("="       PGNSP PGUID b f t    31    31    16 355     0 xideq4 eqsel eqjoinsel));
DESCR("equal");
DATA(insert OID = 356 ("="       PGNSP PGUID b f f    31    23    16     0     0 xideqint4 eqsel eqjoinsel));
DESCR("equal");
DATA(insert OID = 357 ("<"       PGNSP PGUID b f f    31    31    16     0     0 xidlt4 neqsel neqjoinsel));
DESCR("less than");
...
DATA(insert OID = 527 ("/"       PGNSP PGUID b f f    21    21    701     0     0 int2div - -));
DESCR("divide");
#define INT2DIVOID 527
DATA(insert OID = 528 ("/"       PGNSP PGUID b f f    23    23    701     0     0 int4div - -));
DESCR("divide");
...
DATA(insert OID = 546 ("/"       PGNSP PGUID b f f    21    23    701     0     0 int24div - -));
DESCR("divide");
#define INT24DIVOID 546
DATA(insert OID = 547 ("/"       PGNSP PGUID b f f    23    21    701     0     0 int42div - -));
DESCR("divide");
...
DATA(insert OID = 5513 ("="       PGNSP PGUID b t t    5545    5545    16 5513 5514 int1eq eqsel eqjoinsel));
DESCR("equal");
DATA(insert OID = 5514 ("<>"       PGNSP PGUID b f f    5545    5545    16 5514 5513 int1ne neqsel neqjoinsel));
DESCR("not equal");
DATA(insert OID = 5515 ("<"       PGNSP PGUID b f f    5545    5545  16 5517 5518 int1lt scalarltsel scalarltjoinsel));
DESCR("less than");
DATA(insert OID = 5516 ("<="       PGNSP PGUID b f f    5545    5545  16 5518 5517 int1le scalarltsel scalarltjoinsel));
DESCR("less than or equal");
DATA(insert OID = 5517 (">"       PGNSP PGUID b f f    5545    5545  16 5515 5516 int1gt scalargtsel scalargtjoinsel));
DESCR("greater than");
DATA(insert OID = 5518 (">="       PGNSP PGUID b f f    5545    5545  16 5516 5515 int1ge scalargtsel scalargtjoinsel));
DESCR("greater than or equal");
...
DATA(insert OID = 687 ("/"       PGNSP PGUID b f f    20    20    701     0     0 int8div - -));
DESCR("divide");
...
DATA(insert OID = 691 ("/"       PGNSP PGUID b f f    20    23    701     0     0 int84div - -));
DESCR("divide");
...
DATA(insert OID = 695 ("/"       PGNSP PGUID b f f    23    20    701     0     0 int48div - -));
DESCR("divide");
...
DATA(insert OID = 821 ("/"       PGNSP PGUID b f f    20    21    701     0     0 int82div - -));
DESCR("divide");
...
DATA(insert OID = 825 ("/"       PGNSP PGUID b f f    21    20    701     0     0 int28div - -));
DESCR("divide");
...
DESCR("divide");
DATA(insert OID = 3352 ("*"       PGNSP PGUID b f f    790  5545     790 3354  0 cash_mul_int1 - -));
DESCR("multiply");
DATA(insert OID = 3353 ("/"       PGNSP PGUID b f f    790  5545     790   0   0 cash_div_int1 - -));
DESCR("divide");
...
DESCR("multiply");
DATA(insert OID = 3354 ("*"       PGNSP PGUID b f f    5545    790        790 3352  0 int1_mul_cash - -));
DESCR("multiply");
...
/* raw operators */
DATA(insert OID = 3798 ("="       PGNSP PGUID b t t 86 86    16 3798 3799 raweq eqsel eqjoinsel));
DESCR("equal");
DATA(insert OID = 3799 ("<>"       PGNSP PGUID b f f 86 86    16 3799 3798 rawne neqsel neqjoinsel));
DESCR("not equal");
DATA(insert OID = 3800 ("<"       PGNSP PGUID b f f 86 86    16 3802 3803 rawlt scalarltsel scalarltjoinsel));
DESCR("less than");
DATA(insert OID = 3801 ("<="       PGNSP PGUID b f f 86 86    16 3803 3802 rawle scalarltsel scalarltjoinsel));
DESCR("less than or equal");
DATA(insert OID = 3802 (">"       PGNSP PGUID b f f 86 86    16 3800 3801 rawgt scalargtsel scalargtjoinsel));
DESCR("greater than");
DATA(insert OID = 3803 (">="       PGNSP PGUID b f f 86 86    16 3801 3800 rawge scalargtsel scalargtjoinsel));
DESCR("greater than or equal");
DATA(insert OID = 3804 ("~~"       PGNSP PGUID b f f 86 86    16 0    3805 rawlike likesel likejoinsel));
DESCR("matches like expression");
#define OID_RAW_LIKE_OP        3804
DATA(insert OID = 3805 ("!~~"    PGNSP PGUID b f f 86 86    16 0    3804 rawnlike nlikesel nlikejoinsel));
DESCR("does not match like expression");
...
DATA(insert OID = 5550 ("="       PGNSP PGUID b t t 9003 9003     16 5550 5551 smalldatetime_eq eqsel eqjoinsel));
DESCR("equal");
DATA(insert OID = 5551 ("<>"       PGNSP PGUID b f f 9003 9003     16 5551 5550 smalldatetime_ne neqsel neqjoinsel));
DESCR("not equal");
DATA(insert OID = 5552 ("<"       PGNSP PGUID b f f 9003 9003     16 5554 5549 smalldatetime_lt scalarltsel scalarltjoinsel));
DESCR("less than");
DATA(insert OID = 5553 ("<="       PGNSP PGUID b f f 9003 9003     16 5549 5554 smalldatetime_le scalarltsel scalarltjoinsel));
DESCR("less than or equal");
DATA(insert OID = 5554 (">"       PGNSP PGUID b f f 9003 9003     16 5552 5553 smalldatetime_gt scalargtsel scalargtjoinsel));
DESCR("greater than");
DATA(insert OID = 5549 (">="       PGNSP PGUID b f f 9003 9003     16 5553 5552 smalldatetime_ge scalargtsel scalargtjoinsel));
DESCR("greater than or equal");
