 ...
 * ----------------
 */
#define PublicationRelRelationId 6132
#define PublicationRelRelationId_Rowtype_Id 6142
CATALOG(pg_publication_rel,6132) BKI_ROWTYPE_OID(6142) BKI_SCHEMA_MACRO
{
