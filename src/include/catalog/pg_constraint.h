...
#define ConstraintRelation_Rowtype_Id 10001

CATALOG(pg_constraint,2606) BKI_SCHEMA_MACRO
{
    /*
...
#define CONSTRAINT_CLUSTER            's'
#define CONSTRAINT_INVALID            'i'
...
extern List *get_parse_dependency_rel_list(List *conids);

#ifdef PGXC
extern int pgxc_find_primarykey(Oid relid, int16 **indexed_col, bool check_is_immediate = false);
#endif
