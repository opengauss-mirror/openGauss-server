...
#define SharedDependRelation_Rowtype_Id 11635

CATALOG(pg_shdepend,1214) BKI_SHARED_RELATION BKI_WITHOUT_OIDS BKI_SCHEMA_MACRO
{
    /*
    ...
    text        objfile;         /* library file path */
#endif
...
#define Anum_pg_shdepend_objfile     8
