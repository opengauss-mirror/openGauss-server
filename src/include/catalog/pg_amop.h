...
DATA(insert (	3806   86 86 1 s 3800 403 0 ));
DATA(insert (	3806   86 86 2 s 3801 403 0 ));
DATA(insert (	3806   86 86 3 s 3798 403 0 ));
DATA(insert (	3806   86 86 4 s 3803 403 0 ));
DATA(insert (	3806   86 86 5 s 3802 403 0 ));
DATA(insert (	5535   5545 5545 1 s 5515 403 0 ));
DATA(insert (	5535   5545 5545 2 s 5516 403 0 ));
DATA(insert (	5535   5545 5545 3 s 5513 403 0 ));
DATA(insert (	5535   5545 5545 4 s 5518 403 0 ));
DATA(insert (	5535   5545 5545 5 s 5517 403 0 ));
...
/* raw_ops */
DATA(insert (	3807   86 86 1 s 3798 405 0 ));
/* tinyint_ops */
DATA(insert (	5536   5545 5545 1 s 5513 405 0 ));
/* int2vector_ops */
DATA(insert (	2224   22 22 1 s	386 405 0 ));
/* xid_ops */
DATA(insert (	2225   28 28 1 s	352 405 0 ));
DATA(insert (	2232   31 31 1 s        355 405 0 ));
/* cid_ops */
...
/*
 * cgin array_ops (these anyarray operators are used with all the opclasses
 * of the family)
 */
/*
DATA(insert (	4445   2277 2277 1 s 2750 4444 0 ));
DATA(insert (	4445   2277 2277 2 s 2751 4444 0 ));
DATA(insert (	4445   2277 2277 3 s 2752 4444 0 ));
DATA(insert (	4445   2277 2277 4 s 1070 4444 0 ));
*/
 ...
 * CGIN tsvector_ops
 */
DATA(insert (	4446   3614 3615 1 s	3636 4444 0 ));
DATA(insert (	4446   3614 3615 2 s	3660 4444 0 ));
...
DATA(insert (	5570   9003 9003 1 s 5552	403 0 ));
DATA(insert (	5570   9003 9003 2 s 5553	403 0 ));
DATA(insert (	5570   9003 9003 3 s 5550	403 0 ));
DATA(insert (	5570   9003 9003 4 s 5549	403 0 ));
DATA(insert (	5570   9003 9003 5 s 5554	403 0 ));
DATA(insert (	5571   9003 9003 1 s 5550 405 0 ));

/* psort, fake data just make index work */
DATA(insert (	4050	21	21	1	s	95		4039	0 ));
DATA(insert (	4050	21	21	2	s	522		4039	0 ));
DATA(insert (	4050	21	21	3	s	94		4039	0 ));
DATA(insert (	4050	21	21	4	s	524		4039	0 ));
DATA(insert (	4050	21	21	5	s	520		4039	0 ));

DATA(insert (	4050	21	23	1	s	534		4039	0 ));
DATA(insert (	4050	21	23	2	s	540		4039	0 ));
DATA(insert (	4050	21	23	3	s	532		4039	0 ));
DATA(insert (	4050	21	23	4	s	542		4039	0 ));
DATA(insert (	4050	21	23	5	s	536		4039	0 ));

DATA(insert (	4050	21	20	1	s	1864	4039	0 ));
DATA(insert (	4050	21	20	2	s	1866	4039	0 ));
DATA(insert (	4050	21	20	3	s	1862	4039	0 ));
DATA(insert (	4050	21	20	4	s	1867	4039	0 ));
DATA(insert (	4050	21	20	5	s	1865	4039	0 ));

DATA(insert (	4050	23	23	1	s	97		4039	0 ));
DATA(insert (	4050	23	23	2	s	523		4039	0 ));
DATA(insert (	4050	23	23	3	s	96		4039	0 ));
DATA(insert (	4050	23	23	4	s	525		4039	0 ));
DATA(insert (	4050	23	23	5	s	521		4039	0 ));

DATA(insert (	4050	23	21	1	s	535		4039	0 ));
DATA(insert (	4050	23	21	2	s	541		4039	0 ));
DATA(insert (	4050	23	21	3	s	533		4039	0 ));
DATA(insert (	4050	23	21	4	s	543		4039	0 ));
DATA(insert (	4050	23	21	5	s	537		4039	0 ));

DATA(insert (	4050	23	20	1	s	37		4039	0 ));
DATA(insert (	4050	23	20	2	s	80		4039	0 ));
DATA(insert (	4050	23	20	3	s	15		4039	0 ));
DATA(insert (	4050	23	20	4	s	82		4039	0 ));
DATA(insert (	4050	23	20	5	s	76		4039	0 ));

DATA(insert (	4050	20	20	1	s	412		4039	0 ));
DATA(insert (	4050	20	20	2	s	414		4039	0 ));
DATA(insert (	4050	20	20	3	s	410		4039	0 ));
DATA(insert (	4050	20	20	4	s	415		4039	0 ));
DATA(insert (	4050	20	20	5	s	413		4039	0 ));

DATA(insert (	4050	20	21	1	s	1870	4039	0 ));
DATA(insert (	4050	20	21	2	s	1872	4039	0 ));
DATA(insert (	4050	20	21	3	s	1868	4039	0 ));
DATA(insert (	4050	20	21	4	s	1873	4039	0 ));
DATA(insert (	4050	20	21	5	s	1871	4039	0 ));

DATA(insert (	4050	20	23	1	s	418		4039	0 ));
DATA(insert (	4050	20	23	2	s	420		4039	0 ));
DATA(insert (	4050	20	23	3	s	416		4039	0 ));
DATA(insert (	4050	20	23	4	s	430		4039	0 ));
DATA(insert (	4050	20	23	5	s	419		4039	0 ));

DATA(insert (	4051	26	26	1	s	609		4039	0 ));
DATA(insert (	4051	26	26	2	s	611		4039	0 ));
DATA(insert (	4051	26	26	3	s	607		4039	0 ));
DATA(insert (	4051	26	26	4	s	612		4039	0 ));
DATA(insert (	4051	26	26	5	s	610		4039	0 ));

DATA(insert (	4052	1082	1082	1	s	1095	4039	0 ));
DATA(insert (	4052	1082	1082	2	s	1096	4039	0 ));
DATA(insert (	4052	1082	1082	3	s	1093	4039	0 ));
DATA(insert (	4052	1082	1082	4	s	1098	4039	0 ));
DATA(insert (	4052	1082	1082	5	s	1097	4039	0 ));

DATA(insert (	4052	1082	1114	1	s	2345	4039	0 ));
DATA(insert (	4052	1082	1114	2	s	2346	4039	0 ));
DATA(insert (	4052	1082	1114	3	s	2347	4039	0 ));
DATA(insert (	4052	1082	1114	4	s	2348	4039	0 ));
DATA(insert (	4052	1082	1114	5	s	2349	4039	0 ));

DATA(insert (	4052	1082	1184	1	s	2358	4039	0 ));
DATA(insert (	4052	1082	1184	2	s	2359	4039	0 ));
DATA(insert (	4052	1082	1184	3	s	2360	4039	0 ));
DATA(insert (	4052	1082	1184	4	s	2361	4039	0 ));
DATA(insert (	4052	1082	1184	5	s	2362	4039	0 ));

DATA(insert (	4052	1114	1114	1	s	2062	4039	0 ));
DATA(insert (	4052	1114	1114	2	s	2063	4039	0 ));
DATA(insert (	4052	1114	1114	3	s	2060	4039	0 ));
DATA(insert (	4052	1114	1114	4	s	2065	4039	0 ));
DATA(insert (	4052	1114	1114	5	s	2064	4039	0 ));

DATA(insert (	4052	1114	1082	1	s	2371	4039	0 ));
DATA(insert (	4052	1114	1082	2	s	2372	4039	0 ));
DATA(insert (	4052	1114	1082	3	s	2373	4039	0 ));
DATA(insert (	4052	1114	1082	4	s	2374	4039	0 ));
DATA(insert (	4052	1114	1082	5	s	2375	4039	0 ));

DATA(insert (	4052	1114	1184	1	s	2534	4039	0 ));
DATA(insert (	4052	1114	1184	2	s	2535	4039	0 ));
DATA(insert (	4052	1114	1184	3	s	2536	4039	0 ));
DATA(insert (	4052	1114	1184	4	s	2537	4039	0 ));
DATA(insert (	4052	1114	1184	5	s	2538	4039	0 ));

DATA(insert (	4052	1184	1184	1	s	1322	4039	0 ));
DATA(insert (	4052	1184	1184	2	s	1323	4039	0 ));
DATA(insert (	4052	1184	1184	3	s	1320	4039	0 ));
DATA(insert (	4052	1184	1184	4	s	1325	4039	0 ));
DATA(insert (	4052	1184	1184	5	s	1324	4039	0 ));

DATA(insert (	4052	1184	1082	1	s	2384	4039	0 ));
DATA(insert (	4052	1184	1082	2	s	2385	4039	0 ));
DATA(insert (	4052	1184	1082	3	s	2386	4039	0 ));
DATA(insert (	4052	1184	1082	4	s	2387	4039	0 ));
DATA(insert (	4052	1184	1082	5	s	2388	4039	0 ));

DATA(insert (	4052	1184	1114	1	s	2540	4039	0 ));
DATA(insert (	4052	1184	1114	2	s	2541	4039	0 ));
DATA(insert (	4052	1184	1114	3	s	2542	4039	0 ));
DATA(insert (	4052	1184	1114	4	s	2543	4039	0 ));
DATA(insert (	4052	1184	1114	5	s	2544	4039	0 ));

DATA(insert (	4053	700		700		1	s	622		4039	0 ));
DATA(insert (	4053	700		700		2	s	624		4039	0 ));
DATA(insert (	4053	700		700		3	s	620		4039	0 ));
DATA(insert (	4053	700		700		4	s	625		4039	0 ));
DATA(insert (	4053	700		700		5	s	623		4039	0 ));

DATA(insert (	4053	700		701		1	s	1122	4039	0 ));
DATA(insert (	4053	700		701		2	s	1124	4039	0 ));
DATA(insert (	4053	700		701		3	s	1120	4039	0 ));
DATA(insert (	4053	700		701		4	s	1125	4039	0 ));
DATA(insert (	4053	700		701		5	s	1123	4039	0 ));

DATA(insert (	4053	701		701		1	s	672		4039	0 ));
DATA(insert (	4053	701		701		2	s	673		4039	0 ));
DATA(insert (	4053	701		701		3	s	670		4039	0 ));
DATA(insert (	4053	701		701		4	s	675		4039	0 ));
DATA(insert (	4053	701		701		5	s	674		4039	0 ));

DATA(insert (	4053	701		700		1	s	1132	4039	0 ));
DATA(insert (	4053	701		700		2	s	1134	4039	0 ));
DATA(insert (	4053	701		700		3	s	1130	4039	0 ));
DATA(insert (	4053	701		700		4	s	1135	4039	0 ));
DATA(insert (	4053	701		700		5	s	1133	4039	0 ));

DATA(insert (	4054	1700	1700	1	s	1754	4039	0 ));
DATA(insert (	4054	1700	1700	2	s	1755	4039	0 ));
DATA(insert (	4054	1700	1700	3	s	1752	4039	0 ));
DATA(insert (	4054	1700	1700	4	s	1757	4039	0 ));
DATA(insert (	4054	1700	1700	5	s	1756	4039	0 ));

DATA(insert (	4055	25	25	1	s	664		4039	0 ));
DATA(insert (	4055	25	25	2	s	665		4039	0 ));
DATA(insert (	4055	25	25	3	s	98		4039	0 ));
DATA(insert (	4055	25	25	4	s	667		4039	0 ));
DATA(insert (	4055	25	25	5	s	666		4039	0 ));

DATA(insert (	4056	1042	1042	1	s	1058	4039	0 ));
DATA(insert (	4056	1042	1042	2	s	1059	4039	0 ));
DATA(insert (	4056	1042	1042	3	s	1054	4039	0 ));
DATA(insert (	4056	1042	1042	4	s	1061	4039	0 ));
DATA(insert (	4056	1042	1042	5	s	1060	4039	0 ));

DATA(insert (	4057	1083	1083	1	s	1110	4039	0 ));
DATA(insert (	4057	1083	1083	2	s	1111	4039	0 ));
DATA(insert (	4057	1083	1083	3	s	1108	4039	0 ));
DATA(insert (	4057	1083	1083	4	s	1113	4039	0 ));
DATA(insert (	4057	1083	1083	5	s	1112	4039	0 ));

DATA(insert (	4058	1266	1266	1	s	1552	4039	0 ));
DATA(insert (	4058	1266	1266	2	s	1553	4039	0 ));
DATA(insert (	4058	1266	1266	3	s	1550	4039	0 ));
DATA(insert (	4058	1266	1266	4	s	1555	4039	0 ));
DATA(insert (	4058	1266	1266	5	s	1554	4039	0 ));

DATA(insert (	4059	790		790		1	s	902		4039	0 ));
DATA(insert (	4059	790		790		2	s	904		4039	0 ));
DATA(insert (	4059	790		790		3	s	900		4039	0 ));
DATA(insert (	4059	790		790		4	s	905		4039	0 ));
DATA(insert (	4059	790		790		5	s	903		4039	0 ));

DATA(insert (	4060	1186	1186	1	s	1332	4039	0 ));
DATA(insert (	4060	1186	1186	2	s	1333	4039	0 ));
DATA(insert (	4060	1186	1186	3	s	1330	4039	0 ));
DATA(insert (	4060	1186	1186	4	s	1335	4039	0 ));
DATA(insert (	4060	1186	1186	5	s	1334	4039	0 ));

DATA(insert (	4061	704		704		1	s	813		4039	0 ));
DATA(insert (	4061	704		704		2	s	815		4039	0 ));
DATA(insert (	4061	704		704		3	s	811		4039	0 ));
DATA(insert (	4061	704		704		4	s	816		4039	0 ));
DATA(insert (	4061	704		704		5	s	814		4039	0 ));

DATA(insert (	4062	5545	5545	1	s	5515	4039	0 ));
DATA(insert (	4062	5545	5545	2	s	5516	4039	0 ));
DATA(insert (	4062	5545	5545	3	s	5513	4039	0 ));
DATA(insert (	4062	5545	5545	4	s	5518	4039	0 ));
DATA(insert (	4062	5545	5545	5	s	5517	4039	0 ));

DATA(insert (	4063	16	16	1	s	58	    4039	0 ));
DATA(insert (	4063	16	16	2	s	1694	4039	0 ));
DATA(insert (	4063	16	16	3	s	91	    4039	0 ));
DATA(insert (	4063	16	16	4	s	1695	4039	0 ));
DATA(insert (	4063	16	16	5	s	59	    4039	0 ));

DATA(insert (	4064	9003	9003	1	s	5552	4039	0 ));
DATA(insert (	4064	9003	9003	2	s	5553	4039	0 ));
DATA(insert (	4064	9003	9003	3	s	5550	4039	0 ));
DATA(insert (	4064	9003	9003	4	s	5549	4039	0 ));
DATA(insert (	4064	9003	9003	5	s	5554	4039	0 ));

/* cbtree, fake data just make index work */
DATA(insert (	4250	21	21	1	s	95		4239	0 ));
DATA(insert (	4250	21	21	2	s	522		4239	0 ));
DATA(insert (	4250	21	21	3	s	94		4239	0 ));
DATA(insert (	4250	21	21	4	s	524		4239	0 ));
DATA(insert (	4250	21	21	5	s	520		4239	0 ));

DATA(insert (	4250	21	23	1	s	534		4239	0 ));
DATA(insert (	4250	21	23	2	s	540		4239	0 ));
DATA(insert (	4250	21	23	3	s	532		4239	0 ));
DATA(insert (	4250	21	23	4	s	542		4239	0 ));
DATA(insert (	4250	21	23	5	s	536		4239	0 ));

DATA(insert (	4250	21	20	1	s	1864	4239	0 ));
DATA(insert (	4250	21	20	2	s	1866	4239	0 ));
DATA(insert (	4250	21	20	3	s	1862	4239	0 ));
DATA(insert (	4250	21	20	4	s	1867	4239	0 ));
DATA(insert (	4250	21	20	5	s	1865	4239	0 ));

DATA(insert (	4250	23	23	1	s	97		4239	0 ));
DATA(insert (	4250	23	23	2	s	523		4239	0 ));
DATA(insert (	4250	23	23	3	s	96		4239	0 ));
DATA(insert (	4250	23	23	4	s	525		4239	0 ));
DATA(insert (	4250	23	23	5	s	521		4239	0 ));

DATA(insert (	4250	23	21	1	s	535		4239	0 ));
DATA(insert (	4250	23	21	2	s	541		4239	0 ));
DATA(insert (	4250	23	21	3	s	533		4239	0 ));
DATA(insert (	4250	23	21	4	s	543		4239	0 ));
DATA(insert (	4250	23	21	5	s	537		4239	0 ));

DATA(insert (	4250	23	20	1	s	37		4239	0 ));
DATA(insert (	4250	23	20	2	s	80		4239	0 ));
DATA(insert (	4250	23	20	3	s	15		4239	0 ));
DATA(insert (	4250	23	20	4	s	82		4239	0 ));
DATA(insert (	4250	23	20	5	s	76		4239	0 ));

DATA(insert (	4250	20	20	1	s	412		4239	0 ));
DATA(insert (	4250	20	20	2	s	414		4239	0 ));
DATA(insert (	4250	20	20	3	s	410		4239	0 ));
DATA(insert (	4250	20	20	4	s	415		4239	0 ));
DATA(insert (	4250	20	20	5	s	413		4239	0 ));

DATA(insert (	4250	20	21	1	s	1870	4239	0 ));
DATA(insert (	4250	20	21	2	s	1872	4239	0 ));
DATA(insert (	4250	20	21	3	s	1868	4239	0 ));
DATA(insert (	4250	20	21	4	s	1873	4239	0 ));
DATA(insert (	4250	20	21	5	s	1871	4239	0 ));

DATA(insert (	4250	20	23	1	s	418		4239	0 ));
DATA(insert (	4250	20	23	2	s	420		4239	0 ));
DATA(insert (	4250	20	23	3	s	416		4239	0 ));
DATA(insert (	4250	20	23	4	s	430		4239	0 ));
DATA(insert (	4250	20	23	5	s	419		4239	0 ));

DATA(insert (	4251	26	26	1	s	609		4239	0 ));
DATA(insert (	4251	26	26	2	s	611		4239	0 ));
DATA(insert (	4251	26	26	3	s	607		4239	0 ));
DATA(insert (	4251	26	26	4	s	612		4239	0 ));
DATA(insert (	4251	26	26	5	s	610		4239	0 ));

DATA(insert (	4252	1082	1082	1	s	1095	4239	0 ));
DATA(insert (	4252	1082	1082	2	s	1096	4239	0 ));
DATA(insert (	4252	1082	1082	3	s	1093	4239	0 ));
DATA(insert (	4252	1082	1082	4	s	1098	4239	0 ));
DATA(insert (	4252	1082	1082	5	s	1097	4239	0 ));

DATA(insert (	4252	1082	1114	1	s	2345	4239	0 ));
DATA(insert (	4252	1082	1114	2	s	2346	4239	0 ));
DATA(insert (	4252	1082	1114	3	s	2347	4239	0 ));
DATA(insert (	4252	1082	1114	4	s	2348	4239	0 ));
DATA(insert (	4252	1082	1114	5	s	2349	4239	0 ));

DATA(insert (	4252	1082	1184	1	s	2358	4239	0 ));
DATA(insert (	4252	1082	1184	2	s	2359	4239	0 ));
DATA(insert (	4252	1082	1184	3	s	2360	4239	0 ));
DATA(insert (	4252	1082	1184	4	s	2361	4239	0 ));
DATA(insert (	4252	1082	1184	5	s	2362	4239	0 ));

DATA(insert (	4252	1114	1114	1	s	2062	4239	0 ));
DATA(insert (	4252	1114	1114	2	s	2063	4239	0 ));
DATA(insert (	4252	1114	1114	3	s	2060	4239	0 ));
DATA(insert (	4252	1114	1114	4	s	2065	4239	0 ));
DATA(insert (	4252	1114	1114	5	s	2064	4239	0 ));

DATA(insert (	4252	1114	1082	1	s	2371	4239	0 ));
DATA(insert (	4252	1114	1082	2	s	2372	4239	0 ));
DATA(insert (	4252	1114	1082	3	s	2373	4239	0 ));
DATA(insert (	4252	1114	1082	4	s	2374	4239	0 ));
DATA(insert (	4252	1114	1082	5	s	2375	4239	0 ));

DATA(insert (	4252	1114	1184	1	s	2534	4239	0 ));
DATA(insert (	4252	1114	1184	2	s	2535	4239	0 ));
DATA(insert (	4252	1114	1184	3	s	2536	4239	0 ));
DATA(insert (	4252	1114	1184	4	s	2537	4239	0 ));
DATA(insert (	4252	1114	1184	5	s	2538	4239	0 ));

DATA(insert (	4252	1184	1184	1	s	1322	4239	0 ));
DATA(insert (	4252	1184	1184	2	s	1323	4239	0 ));
DATA(insert (	4252	1184	1184	3	s	1320	4239	0 ));
DATA(insert (	4252	1184	1184	4	s	1325	4239	0 ));
DATA(insert (	4252	1184	1184	5	s	1324	4239	0 ));

DATA(insert (	4252	1184	1082	1	s	2384	4239	0 ));
DATA(insert (	4252	1184	1082	2	s	2385	4239	0 ));
DATA(insert (	4252	1184	1082	3	s	2386	4239	0 ));
DATA(insert (	4252	1184	1082	4	s	2387	4239	0 ));
DATA(insert (	4252	1184	1082	5	s	2388	4239	0 ));

DATA(insert (	4252	1184	1114	1	s	2540	4239	0 ));
DATA(insert (	4252	1184	1114	2	s	2541	4239	0 ));
DATA(insert (	4252	1184	1114	3	s	2542	4239	0 ));
DATA(insert (	4252	1184	1114	4	s	2543	4239	0 ));
DATA(insert (	4252	1184	1114	5	s	2544	4239	0 ));

DATA(insert (	4253	700		700		1	s	622		4239	0 ));
DATA(insert (	4253	700		700		2	s	624		4239	0 ));
DATA(insert (	4253	700		700		3	s	620		4239	0 ));
DATA(insert (	4253	700		700		4	s	625		4239	0 ));
DATA(insert (	4253	700		700		5	s	623		4239	0 ));

DATA(insert (	4253	700		701		1	s	1122	4239	0 ));
DATA(insert (	4253	700		701		2	s	1124	4239	0 ));
DATA(insert (	4253	700		701		3	s	1120	4239	0 ));
DATA(insert (	4253	700		701		4	s	1125	4239	0 ));
DATA(insert (	4253	700		701		5	s	1123	4239	0 ));

DATA(insert (	4253	701		701		1	s	672		4239	0 ));
DATA(insert (	4253	701		701		2	s	673		4239	0 ));
DATA(insert (	4253	701		701		3	s	670		4239	0 ));
DATA(insert (	4253	701		701		4	s	675		4239	0 ));
DATA(insert (	4253	701		701		5	s	674		4239	0 ));

DATA(insert (	4253	701		700		1	s	1132	4239	0 ));
DATA(insert (	4253	701		700		2	s	1134	4239	0 ));
DATA(insert (	4253	701		700		3	s	1130	4239	0 ));
DATA(insert (	4253	701		700		4	s	1135	4239	0 ));
DATA(insert (	4253	701		700		5	s	1133	4239	0 ));

DATA(insert (	4254	1700	1700	1	s	1754	4239	0 ));
DATA(insert (	4254	1700	1700	2	s	1755	4239	0 ));
DATA(insert (	4254	1700	1700	3	s	1752	4239	0 ));
DATA(insert (	4254	1700	1700	4	s	1757	4239	0 ));
DATA(insert (	4254	1700	1700	5	s	1756	4239	0 ));

DATA(insert (	4255	25	25	1	s	664		4239	0 ));
DATA(insert (	4255	25	25	2	s	665		4239	0 ));
DATA(insert (	4255	25	25	3	s	98		4239	0 ));
DATA(insert (	4255	25	25	4	s	667		4239	0 ));
DATA(insert (	4255	25	25	5	s	666		4239	0 ));

DATA(insert (	4256	1042	1042	1	s	1058	4239	0 ));
DATA(insert (	4256	1042	1042	2	s	1059	4239	0 ));
DATA(insert (	4256	1042	1042	3	s	1054	4239	0 ));
DATA(insert (	4256	1042	1042	4	s	1061	4239	0 ));
DATA(insert (	4256	1042	1042	5	s	1060	4239	0 ));

DATA(insert (	4257	1083	1083	1	s	1110	4239	0 ));
DATA(insert (	4257	1083	1083	2	s	1111	4239	0 ));
DATA(insert (	4257	1083	1083	3	s	1108	4239	0 ));
DATA(insert (	4257	1083	1083	4	s	1113	4239	0 ));
DATA(insert (	4257	1083	1083	5	s	1112	4239	0 ));

DATA(insert (	4258	1266	1266	1	s	1552	4239	0 ));
DATA(insert (	4258	1266	1266	2	s	1553	4239	0 ));
DATA(insert (	4258	1266	1266	3	s	1550	4239	0 ));
DATA(insert (	4258	1266	1266	4	s	1555	4239	0 ));
DATA(insert (	4258	1266	1266	5	s	1554	4239	0 ));

DATA(insert (	4259	790		790		1	s	902		4239	0 ));
DATA(insert (	4259	790		790		2	s	904		4239	0 ));
DATA(insert (	4259	790		790		3	s	900		4239	0 ));
DATA(insert (	4259	790		790		4	s	905		4239	0 ));
DATA(insert (	4259	790		790		5	s	903		4239	0 ));

DATA(insert (	4260	1186	1186	1	s	1332	4239	0 ));
DATA(insert (	4260	1186	1186	2	s	1333	4239	0 ));
DATA(insert (	4260	1186	1186	3	s	1330	4239	0 ));
DATA(insert (	4260	1186	1186	4	s	1335	4239	0 ));
DATA(insert (	4260	1186	1186	5	s	1334	4239	0 ));

DATA(insert (	4261	704		704		1	s	813		4239	0 ));
DATA(insert (	4261	704		704		2	s	815		4239	0 ));
DATA(insert (	4261	704		704		3	s	811		4239	0 ));
DATA(insert (	4261	704		704		4	s	816		4239	0 ));
DATA(insert (	4261	704		704		5	s	814		4239	0 ));

DATA(insert (	4262	5545	5545	1	s	5515	4239	0 ));
DATA(insert (	4262	5545	5545	2	s	5516	4239	0 ));
DATA(insert (	4262	5545	5545	3	s	5513	4239	0 ));
DATA(insert (	4262	5545	5545	4	s	5518	4239	0 ));
DATA(insert (	4262	5545	5545	5	s	5517	4239	0 ));

DATA(insert (	4263	16	16	1	s	58	    4239	0 ));
DATA(insert (	4263	16	16	2	s	1694	4239	0 ));
DATA(insert (	4263	16	16	3	s	91	    4239	0 ));
DATA(insert (	4263	16	16	4	s	1695	4239	0 ));
DATA(insert (	4263	16	16	5	s	59	    4239	0 ));

DATA(insert (	4264	9003	9003	1	s	5552	4239	0 ));
DATA(insert (	4264	9003	9003	2	s	5553	4239	0 ));
DATA(insert (	4264	9003	9003	3	s	5550	4239	0 ));
DATA(insert (	4264	9003	9003	4	s	5549	4239	0 ));
DATA(insert (	4264	9003	9003	5	s	5554	4239	0 ));
