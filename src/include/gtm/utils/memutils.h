...
#include "gtm/utils/memnodes.h"

enum GTMMemoryContextType {
...
extern MemoryContext MemoryContextCreate(
    Size size, MemoryContextMethods* methods, MemoryContext parent, const char* name);
...
/* aset.c */
extern MemoryContext AllocSetContextCreate(
