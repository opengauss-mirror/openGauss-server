 ...
 */
extern void printfGTMPQExpBuffer(PQExpBuffer str, const char* fmt, ...)
 ...
 * strcat.
 */
extern void appendGTMPQExpBuffer(PQExpBuffer str, const char* fmt, ...)
    /* This extension allows gcc to check the format string */
    __attribute__((format(printf, 2, 3)));
 ...
 * if necessary.
 */
extern void appendBinaryGTMPQExpBuffer(PQExpBuffer str, const char* data, size_t datalen);
