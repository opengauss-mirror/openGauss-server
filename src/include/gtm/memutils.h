 ...
 */
extern MemoryContext MemoryContextCreate(Size size, MemoryContextMethods *methods, MemoryContext parent,
                                         const char *name);
...
extern MemoryContext AllocSetContextCreate(MemoryContext parent, const char *name, Size minContextSize,
                                           Size initBlockSize, Size maxBlockSize, bool isShared);
