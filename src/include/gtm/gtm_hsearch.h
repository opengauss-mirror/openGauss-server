...
#define HASH_HEAP_MEM 0x2000       /* Hashtable is in heap memory */
#define HASH_EXTERN_CONTEXT 0x4000 /* use extern context directly */
#define HASH_SHRCTX 0x8000         /* Set shared memory allocation context */
...
extern void *hash_search(HTAB *hashpPtr, const void *keyPtr, HASHACTION action, bool *foundPtr);
extern uint32 get_hash_value(HTAB *hashp, const void *keyPtr);
extern void *hash_search_with_hash_value(HTAB *hashpPtr, const void *keyPtr, uint32 hashvalue, HASHACTION action,
                                         bool *foundPtr);
