...
extern BlockNumber RelationGetNumberOfBlocksInFork(Relation relation, ForkNumber forkNum);
...
extern void DropRelFileNodeAllBuffers(const RelFileNodeBackend& rnode);
