...
extern void seg_write_back(File file, off_t offset, uint32 size);
extern void FileAllocate(File file, uint32 offset, uint32 size);
extern void seg_file_allocate(File file, uint32 offset, uint32 size);
...
extern int seg_file_read(File file, char* buffer, int amount, off_t offset, uint32 wait_event_info = 0);
extern int FilePWrite(File file, const char *buffer, int amount, off_t offset, uint32 wait_event_info = 0,
    int fastExtendSize = 0);
extern int seg_file_write(File file, const char *buffer, int amount, off_t offset, uint32 wait_event_info = 0);
