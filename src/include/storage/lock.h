...
#define ShareUpdateExclusiveLock  \
    4 /* VACUUM (non-FULL),ANALYZE, CREATE INDEX CONCURRENTLY */
...
#define SET_LOCKTAG_RELATION(locktag, dboid, reloid)                                                        \
    ((locktag).locktag_field1 = (dboid), (locktag).locktag_field2 = (reloid), (locktag).locktag_field3 = 0, \
     (locktag).locktag_field4 = 0, (locktag).locktag_field5 = 0, (locktag).locktag_type = LOCKTAG_RELATION, \
     (locktag).locktag_lockmethodid = DEFAULT_LOCKMETHOD)

#define SET_LOCKTAG_RELATION_EXTEND(locktag, dboid, reloid, bucketid)                                       \
    ((locktag).locktag_field1 = (dboid), (locktag).locktag_field2 = (reloid), (locktag).locktag_field3 = 0, \
     (locktag).locktag_field4 = 0, (locktag).locktag_field5 = (uint16)(bucketid),                           \
     (locktag).locktag_type = LOCKTAG_RELATION_EXTEND, (locktag).locktag_lockmethodid = DEFAULT_LOCKMETHOD)

#define SET_LOCKTAG_PAGE(locktag, dboid, reloid, bucketid, blocknum)                                                 \
    ((locktag).locktag_field1 = (dboid), (locktag).locktag_field2 = (reloid), (locktag).locktag_field3 = (blocknum), \
     (locktag).locktag_field4 = 0, (locktag).locktag_field5 = (uint16)(bucketid),                                    \
     (locktag).locktag_type = LOCKTAG_PAGE, (locktag).locktag_lockmethodid = DEFAULT_LOCKMETHOD)

#define SET_LOCKTAG_TUPLE(locktag, dboid, reloid, bucketid, blocknum, offnum)                                        \
    ((locktag).locktag_field1 = (dboid), (locktag).locktag_field2 = (reloid), (locktag).locktag_field3 = (blocknum), \
     (locktag).locktag_field4 = (offnum), (locktag).locktag_field5 = (uint16)(bucketid),                             \
     (locktag).locktag_type = LOCKTAG_TUPLE, (locktag).locktag_lockmethodid = DEFAULT_LOCKMETHOD)

#define SET_LOCKTAG_TRANSACTION(locktag, xid)                                                                   \
    ((locktag).locktag_field1 = (uint32)((xid)&0xFFFFFFFF), (locktag).locktag_field2 = (uint32)((xid) >> 32), \
     (locktag).locktag_field3 = 0, (locktag).locktag_field4 = 0, (locktag).locktag_field5 = 0,                 \
     (locktag).locktag_type = LOCKTAG_TRANSACTION, (locktag).locktag_lockmethodid = DEFAULT_LOCKMETHOD)

#define SET_LOCKTAG_VIRTUALTRANSACTION(locktag, vxid)                                                    \
    ((locktag).locktag_field1 = (vxid).backendId,                                                        \
     (locktag).locktag_field2 = (uint32)((vxid).localTransactionId & 0xFFFFFFFF),                        \
     (locktag).locktag_field3 = (uint32)((vxid).localTransactionId >> 32), (locktag).locktag_field4 = 0, \
     (locktag).locktag_field5 = 0, (locktag).locktag_type = LOCKTAG_VIRTUALTRANSACTION,                   \
     (locktag).locktag_lockmethodid = DEFAULT_LOCKMETHOD)

#define SET_LOCKTAG_OBJECT(locktag, dboid, classoid, objoid, objsubid)                                               \
    ((locktag).locktag_field1 = (dboid), (locktag).locktag_field2 = (classoid), (locktag).locktag_field3 = (objoid), \
     (locktag).locktag_field4 = (objsubid), (locktag).locktag_field5 = 0, (locktag).locktag_type = LOCKTAG_OBJECT, \
     (locktag).locktag_lockmethodid = DEFAULT_LOCKMETHOD)

#define SET_LOCKTAG_ADVISORY(locktag, id1, id2, id3, id4)                                                  \
    ((locktag).locktag_field1 = (id1), (locktag).locktag_field2 = (id2), (locktag).locktag_field3 = (id3), \
     (locktag).locktag_field4 = (id4), (locktag).locktag_field5 = 0, (locktag).locktag_type = LOCKTAG_ADVISORY, \
     (locktag).locktag_lockmethodid = USER_LOCKMETHOD)

#define SET_LOCKTAG_PARTITION(locktag, id1, id2, id3)                                                      \
    ((locktag).locktag_field1 = (id1), (locktag).locktag_field2 = (id2), (locktag).locktag_field3 = (id3), \
     (locktag).locktag_field4 = 0, (locktag).locktag_field5 = 0, (locktag).locktag_type = LOCKTAG_PARTITION, \
     (locktag).locktag_lockmethodid = DEFAULT_LOCKMETHOD)

#define SET_LOCKTAG_PARTITION_SEQUENCE(locktag, id1, id2, id3)                                             \
    ((locktag).locktag_field1 = (id1), (locktag).locktag_field2 = (id2), (locktag).locktag_field3 = (id3), \
     (locktag).locktag_field4 = 0, (locktag).locktag_field5 = 0, (locktag).locktag_type = LOCKTAG_PARTITION_SEQUENCE, \
     (locktag).locktag_lockmethodid = DEFAULT_LOCKMETHOD)

#define SET_LOCKTAG_CSTORE_FREESPACE(locktag, id1, id2)                                                \
    ((locktag).locktag_field1 = (id1), (locktag).locktag_field2 = (id2), (locktag).locktag_field3 = 0, \
     (locktag).locktag_field4 = 0, (locktag).locktag_field5 = 0, (locktag).locktag_type = LOCKTAG_CSTORE_FREESPACE, \
     (locktag).locktag_lockmethodid = DEFAULT_LOCKMETHOD)
...
extern int LockCheckConflicts(LockMethod lockMethodTable, LOCKMODE lockmode, LOCK *lock, PROCLOCK *proclock,
                              PGPROC *proc);
extern bool IsInSameParallelQuery(PGPROC *proc1, PGPROC *proc2);
...
extern void RememberSimpleDeadLock(const PGPROC *proc1, LOCKMODE lockmode, const LOCK *lock, const PGPROC *proc2);
