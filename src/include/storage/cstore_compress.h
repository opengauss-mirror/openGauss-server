 ...
 * 
 * IDENTIFICATION
 *        src/include/storage/cstore_compress.h
 *
 * ---------------------------------------------------------------------------------------
 */
...
#ifdef ENABLE_UT
extern short Int32ValueLog(uint16 value);
extern int CompactAscaleCodesBy3Bits(uint8* outBuf, uint8* inValues, int nInValues);
extern int ParseAscaleCodesBy3Bits(uint8* inBuf, uint8* outValues, int nOutValues);
extern int CompactDscaleCodesBy2Bits(uint8* outBuf, uint8* inValues, int nInValues);
extern int ParseDscaleCodesBy2Bits(uint8* inBuf, uint8* outValues, int nOutValues);
#endif
