...
extern JoinExpr* convert_EXISTS_sublink_to_join(
    PlannerInfo* root, SubLink* sublink, bool under_not, Relids available_rels);
extern Node* convert_EXPR_sublink_to_join(PlannerInfo* root, Node** jtlink1, OpExpr* inout_quals, SubLink* sublink,
...
extern bool can_convert_ORCLAUSE_to_JOIN(Node* node);
...
#endif
extern List* pull_sublink(Node* node, bool skipOpExpr = false);
