...
extern LogicalTapeSet* LogicalTapeSetCreate(int ntapes, const TapeShare *shared, SharedFileSet *fileset, int worker);
...
extern void LogicalTapeFreeze(LogicalTapeSet* lts, int tapenum, TapeShare *share);
