...
extern Datum pg_avg_row_length(PG_FUNCTION_ARGS);
extern Datum pg_get_index_type(PG_FUNCTION_ARGS);
extern Datum attnum_used_by_indexprs(PG_FUNCTION_ARGS);
extern Datum pg_get_partition_expression(PG_FUNCTION_ARGS);
...
extern Datum nls_lower_plain(PG_FUNCTION_ARGS);
extern Datum nls_lower_fmt(PG_FUNCTION_ARGS);
extern Datum nls_lower_byte(PG_FUNCTION_ARGS);
extern Datum nls_lower_fmt_byte(PG_FUNCTION_ARGS);
...
extern Datum get_online_ddl_status(PG_FUNCTION_ARGS);
