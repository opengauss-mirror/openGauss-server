...
extern List* transformRangePartitionValueInternal(ParseState* pstate, List* boundary, bool needCheck, bool needFree);
extern Node* transformIntoConst(ParseState* pstate, Node* maxElem);
...
extern void checkPartitionName(List* partitionList);

extern Oid searchSeqidFromExpr(Node* cooked_default);
extern bool is_start_end_def_list(List* def_list);
extern void get_range_partition_name_prefix(char* namePrefix, char* srcName, bool printNotice = false);
