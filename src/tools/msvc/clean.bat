...
if %DIST%==1 if exist src\backend\parser\gram.h del /q src\backend\parser\gram.hpp
...
if %DIST%==1 if exist src\pl\plpgsql\src\pl_gram.c del /q src\pl\plpgsql\src\pl_gram.cpp
if %DIST%==1 if exist src\pl\plpgsql\src\pl_gram.h del /q src\pl\plpgsql\src\pl_gram.hpp
