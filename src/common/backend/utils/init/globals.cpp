...
const uint32 DOLPHIN_ENABLE_DROP_NUM = 92780;
...
const uint32 ADVANCE_CATALOG_XMIN_VERSION_NUM = 92609;
...
const uint32 SKIP_LOCKED_VERSION_NUM = 92779;
...
const uint32 MULTI_PARTITIONS_VERSION_NUM = 92755;

const uint32 CSN_TIME_BARRIER_VERSION = 92751;
const uint32 MULTI_MODIFY_VERSION_NUM = 92764;
const uint32 COMMENT_SUPPORT_VERSION_NUM = 92612;
const uint32 ON_UPDATE_TIMESTAMP_VERSION_NUM = 92614;

const uint32 STANDBY_STMTHIST_VERSION_NUM = 92777;
