...
extern "C" Datum big5_to_utf8(PG_FUNCTION_ARGS);
extern "C" Datum utf8_to_big5(PG_FUNCTION_ARGS);
...
Datum big5_to_utf8(PG_FUNCTION_ARGS)
{
    ...
    LocalToUtf(src, dest, LUmapBIG5, NULL, sizeof(LUmapBIG5) / sizeof(pg_local_to_utf), 0, PG_BIG5, len);
...
Datum utf8_to_big5(PG_FUNCTION_ARGS)
{
    ...
    UtfToLocal(src, dest, ULmapBIG5, NULL, sizeof(ULmapBIG5) / sizeof(pg_utf_to_local), 0, PG_BIG5, len);
