...
Datum euc_tw_to_utf8(PG_FUNCTION_ARGS)
{
    ...
    LocalToUtf(src, len, dest, LUmapEUC_TW, lengthof(LUmapEUC_TW), NULL, 0, NULL, PG_EUC_TW);
...
Datum utf8_to_euc_tw(PG_FUNCTION_ARGS)
{
    ...
    UtfToLocal(src, len, dest, ULmapEUC_TW, lengthof(ULmapEUC_TW), NULL, 0, NULL, PG_EUC_TW);
