...
extern "C" Datum euc_tw_to_utf8(PG_FUNCTION_ARGS);
extern "C" Datum utf8_to_euc_tw(PG_FUNCTION_ARGS);
...
Datum euc_tw_to_utf8(PG_FUNCTION_ARGS)
{
    ...
    LocalToUtf(src, dest, LUmapEUC_TW, NULL, sizeof(LUmapEUC_TW) / sizeof(pg_local_to_utf), 0, PG_EUC_TW, len);
...
Datum utf8_to_euc_tw(PG_FUNCTION_ARGS)
{
    ...
    UtfToLocal(src, dest, ULmapEUC_TW, NULL, sizeof(ULmapEUC_TW) / sizeof(pg_utf_to_local), 0, PG_EUC_TW, len);
