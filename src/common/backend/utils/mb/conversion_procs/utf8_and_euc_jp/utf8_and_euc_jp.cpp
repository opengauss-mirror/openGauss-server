...
Datum euc_jp_to_utf8(PG_FUNCTION_ARGS)
{
    ...
    LocalToUtf(src, len, dest, LUmapEUC_JP, lengthof(LUmapEUC_JP), NULL, 0, NULL, PG_EUC_JP);
...
Datum utf8_to_euc_jp(PG_FUNCTION_ARGS)
{
    ...
    UtfToLocal(src, len, dest, ULmapEUC_JP, lengthof(ULmapEUC_JP), NULL, 0, NULL, PG_EUC_JP);
