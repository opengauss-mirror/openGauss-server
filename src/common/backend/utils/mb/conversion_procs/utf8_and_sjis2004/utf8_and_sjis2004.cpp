...
extern "C" Datum shift_jis_2004_to_utf8(PG_FUNCTION_ARGS);
extern "C" Datum utf8_to_shift_jis_2004(PG_FUNCTION_ARGS);
 ...
 * ----------
 */
Datum shift_jis_2004_to_utf8(PG_FUNCTION_ARGS)
{
    ...
    LocalToUtf(src,
        ...
        dest,
        LUmapSHIFT_JIS_2004,
        lengthof(LUmapSHIFT_JIS_2004),
        LUmapSHIFT_JIS_2004_combined,
        lengthof(LUmapSHIFT_JIS_2004_combined),
        NULL,
        PG_SHIFT_JIS_2004);
