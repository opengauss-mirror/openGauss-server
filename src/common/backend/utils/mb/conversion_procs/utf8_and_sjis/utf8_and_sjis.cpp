...
extern "C" Datum sjis_to_utf8(PG_FUNCTION_ARGS);
extern "C" Datum utf8_to_sjis(PG_FUNCTION_ARGS);
...
Datum sjis_to_utf8(PG_FUNCTION_ARGS)
{
    ...
    LocalToUtf(src, dest, LUmapSJIS, NULL, sizeof(LUmapSJIS) / sizeof(pg_local_to_utf), 0, PG_SJIS, len);
...
Datum utf8_to_sjis(PG_FUNCTION_ARGS)
{
    ...
    UtfToLocal(src, dest, ULmapSJIS, NULL, sizeof(ULmapSJIS) / sizeof(pg_utf_to_local), 0, PG_SJIS, len);
