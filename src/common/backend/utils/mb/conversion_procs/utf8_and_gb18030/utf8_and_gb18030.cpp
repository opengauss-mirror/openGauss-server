...
Datum gb18030_to_utf8(PG_FUNCTION_ARGS)
{
    ...
    LocalToUtf(src, dest, LUmapGB18030, NULL, sizeof(LUmapGB18030) / sizeof(pg_local_to_utf), 0, PG_GB18030, len);
...
Datum utf8_to_gb18030(PG_FUNCTION_ARGS)
{
    ...
    UtfToLocal(src, dest, ULmapGB18030, NULL, sizeof(ULmapGB18030) / sizeof(pg_utf_to_local), 0, PG_GB18030, len);
