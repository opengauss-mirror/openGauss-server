...
{
    uint32 b0 = (gb & 0xff000000) >> 24; /* move 3 bytes to right */
    uint32 b1 = (gb & 0x00ff0000) >> 16; /* move 2 bytes to right */
    uint32 b2 = (gb & 0x0000ff00) >> 8; /* move 1 byte to right */
...
Datum gb18030_to_utf8(PG_FUNCTION_ARGS)
{
    ...
    LocalToUtf(src, len, dest, LUmapGB18030, lengthof(LUmapGB18030), NULL, 0, conv_18030_to_utf8, PG_GB18030);
