...
Datum utf8_to_koi8r(PG_FUNCTION_ARGS)
{
    ...
    UtfToLocal(src, len, dest, ULmapKOI8R, lengthof(ULmapKOI8R), NULL, 0, NULL, PG_KOI8R);
...
Datum koi8r_to_utf8(PG_FUNCTION_ARGS)
{
    ...
    LocalToUtf(src, len, dest, LUmapKOI8R, lengthof(LUmapKOI8R), NULL, 0, NULL, PG_KOI8R);
...
Datum utf8_to_koi8u(PG_FUNCTION_ARGS)
{
    ...
    UtfToLocal(src, len, dest, ULmapKOI8U, lengthof(ULmapKOI8U), NULL, 0, NULL, PG_KOI8U);
...
Datum koi8u_to_utf8(PG_FUNCTION_ARGS)
{
    ...
    LocalToUtf(src, len, dest, LUmapKOI8U, lengthof(LUmapKOI8U), NULL, 0, NULL, PG_KOI8U);
