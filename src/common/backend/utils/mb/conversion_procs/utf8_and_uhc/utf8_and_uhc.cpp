...
extern "C" Datum uhc_to_utf8(PG_FUNCTION_ARGS);
extern "C" Datum utf8_to_uhc(PG_FUNCTION_ARGS);
...
Datum uhc_to_utf8(PG_FUNCTION_ARGS)
{
    ...
    LocalToUtf(src, dest, LUmapUHC, NULL, sizeof(LUmapUHC) / sizeof(pg_local_to_utf), 0, PG_UHC, len);
...
Datum utf8_to_uhc(PG_FUNCTION_ARGS)
{
    ...
    UtfToLocal(src, dest, ULmapUHC, NULL, sizeof(ULmapUHC) / sizeof(pg_utf_to_local), 0, PG_UHC, len);
