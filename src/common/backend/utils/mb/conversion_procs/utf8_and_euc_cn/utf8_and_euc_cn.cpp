...
extern "C" Datum euc_cn_to_utf8(PG_FUNCTION_ARGS);
extern "C" Datum utf8_to_euc_cn(PG_FUNCTION_ARGS);
...
Datum euc_cn_to_utf8(PG_FUNCTION_ARGS)
{
    ...
    LocalToUtf(src, dest, LUmapEUC_CN, NULL, sizeof(LUmapEUC_CN) / sizeof(pg_local_to_utf), 0, PG_EUC_CN, len);
...
Datum utf8_to_euc_cn(PG_FUNCTION_ARGS)
{
    ...
    UtfToLocal(src, dest, ULmapEUC_CN, NULL, sizeof(ULmapEUC_CN) / sizeof(pg_utf_to_local), 0, PG_EUC_CN, len);
