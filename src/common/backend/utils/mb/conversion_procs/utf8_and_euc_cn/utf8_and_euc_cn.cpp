...
Datum euc_cn_to_utf8(PG_FUNCTION_ARGS)
{
    ...
    LocalToUtf(src, len, dest, LUmapEUC_CN, lengthof(LUmapEUC_CN), NULL, 0, NULL, PG_EUC_CN);
...
Datum utf8_to_euc_cn(PG_FUNCTION_ARGS)
{
    ...
    UtfToLocal(src, len, dest, ULmapEUC_CN, lengthof(ULmapEUC_CN), NULL, 0, NULL, PG_EUC_CN);
