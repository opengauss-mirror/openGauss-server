...
extern "C" Datum latin1_to_mic(PG_FUNCTION_ARGS);
extern "C" Datum mic_to_latin1(PG_FUNCTION_ARGS);
extern "C" Datum latin3_to_mic(PG_FUNCTION_ARGS);
extern "C" Datum mic_to_latin3(PG_FUNCTION_ARGS);
extern "C" Datum latin4_to_mic(PG_FUNCTION_ARGS);
extern "C" Datum mic_to_latin4(PG_FUNCTION_ARGS);
