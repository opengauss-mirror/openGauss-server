...
extern "C" Datum ascii_to_mic(PG_FUNCTION_ARGS);
extern "C" Datum mic_to_ascii(PG_FUNCTION_ARGS);
 ...
 * ----------
 */
Datum ascii_to_mic(PG_FUNCTION_ARGS)
{
...
Datum mic_to_ascii(PG_FUNCTION_ARGS)
{
    unsigned char* src = (unsigned char*)PG_GETARG_CSTRING(2);
    unsigned char* dest = (unsigned char*)PG_GETARG_CSTRING(3);
    int len = PG_GETARG_INT32(4);
