 ...
 *
 * IDENTIFICATION
 *    src/common/backend/utils/adt/ryu/d2s_intrinsics.h
 *
...
inline uint64 umul128(const uint64 a, const uint64 b, uint64 *const productHi)
{
    return _umul128(a, b, productHi);
}

inline uint64 shiftright128(const uint64 lo, const uint64 hi, const uint32 dist)
{
    /*
...
inline uint64 umulh(const uint64 a, const uint64 b)
{
    /*
