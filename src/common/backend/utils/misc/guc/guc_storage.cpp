...
static void InitStorageConfigureNamesBool()
{
    struct config_bool localConfigureNamesBool[] = {
        ...
        {{"enable_hnswpq",
            ...
            NODE_SINGLENODE,
            QUERY_TUNING_OTHER,
            gettext_noop("Whether enable hnswpq"),
            NULL},
            &g_instance.attr.attr_storage.enable_hnswpq,
            false,
            NULL,
            NULL,
            NULL},
...
static void InitStorageConfigureNamesString()
{
    struct config_string localConfigureNamesString[] = {
        ...
        {{"uwal_log_path",
            ...
            NULL,
            NULL},
        {{"lmemfabric_client_path",
            PGC_POSTMASTER,
            NODE_ALL,
            DEVELOPER_OPTIONS,
            gettext_noop("Sets file path of lmemfabric_client.so."),
            NULL},
            &g_instance.attr.attr_storage.lmemfabric_client_path,
            "libmemfabric_client.so",
            NULL,
            NULL,
            NULL},
        {{NULL,
