...
static void InitSqlConfigureNamesBool()
{
    struct config_bool localConfigureNamesBool[] = {
        ...
        {{"enable_streaming",
            ...
            NULL,
            NULL},
        {{"enable_low_concurrency_optimize",
            PGC_USERSET,
            NODE_SINGLENODE,
            QUERY_TUNING,
            gettext_noop("enable_low_concurrency_optimize"),
            NULL},
            &g_instance.wal_cxt.lowConOpt,
            false,
            NULL,
            NULL,
            NULL},
        {{"enable_pbe_function_call_optimize",
            PGC_USERSET,
            NODE_SINGLENODE,
            QUERY_TUNING,
            gettext_noop("enable pbe function call optimize"),
            NULL},
            &u_sess->exec_cxt.isPbeFunctionCallOpt,
            false,
            NULL,
            NULL,
            NULL},
...
static void InitSqlConfigureNamesInt()
{
    struct config_int localConfigureNamesInt[] = {
        ...
        {{"streaming_gather_window_interval",
            ...
            NULL,
            NULL},
        {{"max_parameterized_query_stored",
            PGC_USERSET,
            NODE_ALL,
            UNGROUPED,
            gettext_noop("Max number of parameterized queries to be stored"),
            NULL},
            &u_sess->attr.attr_sql.max_parameterized_query_stored,
            256,
            1,
            512,
            NULL,
