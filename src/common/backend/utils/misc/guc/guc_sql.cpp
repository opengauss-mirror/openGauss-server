...
static void InitSqlConfigureNamesBool()
{
    struct config_bool localConfigureNamesBool[] = {
        ...
        {{"enable_indexscan_prefetch",
            ...
            NODE_ALL,
            RESOURCES_ASYNCHRONOUS,
            gettext_noop("Enables prefetching of heap pages in local btree index scans."),
            NULL},
            &u_sess->attr.attr_sql.enable_indexscan_prefetch,
            true,
            NULL,
            NULL,
            NULL},
        ...
        {{"enable_indexonlyscan_prefetch",
            ...
            NODE_ALL,
            RESOURCES_ASYNCHRONOUS,
            gettext_noop("Enables prefetching of leaf pages in local btree index-only scans."),
            NULL},
            &u_sess->attr.attr_sql.enable_indexonlyscan_prefetch,
            true,
            NULL,
            NULL,
            NULL},
