...
CREATE FUNCTION _pg_keysequal(smallint[], smallint[]) RETURNS boolean
    LANGUAGE sql IMMUTABLE NOT FENCED -- intentionally not STRICT, to allow inlining
...
CREATE FUNCTION _pg_char_octet_length(typid oid, typmod int4) RETURNS integer
    ...
    AS
$$SELECT
  CASE WHEN $1 IN (25, 1042, 1043, 3969) /* text, char, varchar ,nvarchar2*/
...
CREATE FUNCTION _pg_numeric_precision_radix(typid oid, typmod int4) RETURNS integer
    ...
    AS
$$SELECT
  CASE WHEN $1 IN (5545, 21, 23, 20, 700, 701) THEN 2
...
CREATE FUNCTION _pg_numeric_scale(typid oid, typmod int4) RETURNS integer
    ...
    AS
$$SELECT
  CASE WHEN $1 IN (5545, 21, 23, 20) THEN 0
       WHEN $1 IN (1700) THEN
            CASE WHEN $2 = -1
                 THEN null::integer
                 ELSE ($2 - 4) & 65535
...
CREATE FUNCTION _pg_datetime_precision(typid oid, typmod int4) RETURNS integer
    ...
    AS
$$SELECT
  CASE WHEN $1 IN (1082, 9003) /* date ,smalldatetime*/
           THEN 0
