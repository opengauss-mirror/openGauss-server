...
static const DbPrivMap dbPrivMap[] = {{"CREATE ANY TABLE", "create any table", false},
    ...
    {"ALTER ANY TYPE", "alter any type", false},
    {"ALTER ANY TYPE WITH ADMIN OPTION", "alter any type", true},
    {"DROP ANY TYPE", "drop any type", false},
    {"DROP ANY TYPE WITH ADMIN OPTION", "drop any type", true},
    {"ALTER ANY SEQUENCE", "alter any sequence", false},
    {"ALTER ANY SEQUENCE WITH ADMIN OPTION", "alter any sequence", true},
    {"DROP ANY SEQUENCE", "drop any sequence", false},
    {"DROP ANY SEQUENCE WITH ADMIN OPTION", "drop any sequence", true},
    {"SELECT ANY SEQUENCE", "select any sequence", false},
    {"SELECT ANY SEQUENCE WITH ADMIN OPTION", "select any sequence", true},
    {"ALTER ANY INDEX", "alter any index", false},
    {"ALTER ANY INDEX WITH ADMIN OPTION", "alter any index", true},
    {"DROP ANY INDEX", "drop any index", false},
    {"DROP ANY INDEX WITH ADMIN OPTION", "drop any index", true},
    {"CREATE PUBLIC SYNONYM", "create public synonym", false},
    {"CREATE PUBLIC SYNONYM WITH ADMIN OPTION", "create public synonym", true},
    {"CREATE ANY SYNONYM", "create any synonym", false},
    {"CREATE ANY SYNONYM WITH ADMIN OPTION", "create any synonym", true},
    {"DROP PUBLIC SYNONYM", "drop public synonym", false},
    {"DROP PUBLIC SYNONYM WITH ADMIN OPTION", "drop public synonym", true},
    {"DROP ANY SYNONYM", "drop any synonym", false},
    {"DROP ANY SYNONYM WITH ADMIN OPTION", "drop any synonym", true},
    {"CREATE ANY TRIGGER", "create any trigger", false},
    {"CREATE ANY TRIGGER WITH ADMIN OPTION", "create any trigger", true},
    {"ALTER ANY TRIGGER", "alter any trigger", false},
    {"ALTER ANY TRIGGER WITH ADMIN OPTION", "alter any trigger", true},
    {"DROP ANY TRIGGER", "drop any trigger", false},
    {"DROP ANY TRIGGER WITH ADMIN OPTION", "drop any trigger", true},
    {NULL, NULL, false}};
