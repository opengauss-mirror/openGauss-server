...
!IF "$(SSL_INC)" == ""
SSL_INC=.\src\include
!MESSAGE Using default SSL Include directory: $(SSL_INC)
!ENDIF

!IF "$(SSL_LIB_PATH)" == ""
SSL_LIB_PATH=.\..\Platform\ssl\win32
!MESSAGE Using default SSL Library directory: $(SSL_LIB_PATH)
!ENDIF
...
CLEAN :
	...
	-@erase "$(INTDIR)\pg_crc.obj"
	-@erase "$(INTDIR)\pgstrcasestr.obj"
...
SSL_LIBS=libssl.lib libpse.lib libcrypto.lib libosal.lib
!ENDIF
...
"$(INTDIR)\cipher.obj" : ..\..\port\cipher.c
	$(CPP) @<<
	$(CPP_PROJ) ..\..\port\cipher.c
<<
...
"$(INTDIR)\pg_crc.obj" : ..\..\port\pg_crc.c
	$(CPP) @<<
	$(CPP_PROJ) ..\..\port\pg_crc.c
<<

"$(INTDIR)\pgstrcasestr.obj" : ..\..\port\pgstrcasestr.c
	$(CPP) @<<
	$(CPP_PROJ) ..\..\port\pgstrcasestr.c
<<
