...
#line 35 "dynalloc.pgc"

    {
        ECPGdo(__LINE__,
            ...
            0,
            ECPGst_normal,
            "create table test ( a serial , b numeric ( 12 , 3 ) , c varchar , d varchar ( 3 ) , e char ( 4 ) , f "
            "timestamptz , g boolean , h box , i inet )",
            ECPGt_EOIT,
            ECPGt_EORT);
...
#line 37 "dynalloc.pgc"

    {
        ECPGdo(__LINE__,
            ...
            0,
            ECPGst_normal,
            "insert into test ( b , c , d , e , f , g , h , i ) values ( 23.456 , 'varchar' , 'v' , 'c' , '2003-03-03 "
            "12:33:07 PDT' , true , '(1,2,3,4)' , '2001:4f8:3:ba:2e0:81ff:fe22:d1f1/128' )",
            ECPGt_EOIT,
            ECPGt_EORT);
...
#line 38 "dynalloc.pgc"

    {
        ECPGdo(__LINE__,
            ...
            0,
            ECPGst_normal,
            "insert into test ( b , c , d , e , f , g , h , i ) values ( 2.446456 , null , 'v' , 'c' , '2003-03-03 "
            "12:33:07 PDT' , false , null , null )",
            ECPGt_EOIT,
            ECPGt_EORT);
