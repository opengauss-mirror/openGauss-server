...
#line 27 "dynalloc2.pgc"
    ...
    {
        ECPGdo(
            __LINE__, 0, 1, NULL, 0, ECPGst_normal, "insert into test values ( 4 , 'four' )", ECPGt_EOIT, ECPGt_EORT);
...
#line 29 "dynalloc2.pgc"
    ...
    {
        ECPGdo(
            __LINE__, 0, 1, NULL, 0, ECPGst_normal, "insert into test values ( null , null )", ECPGt_EOIT, ECPGt_EORT);
