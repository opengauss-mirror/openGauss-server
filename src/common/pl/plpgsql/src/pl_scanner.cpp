...
static const ScanKeyword reserved_keywords[] = {PG_KEYWORD("all", K_ALL, RESERVED_KEYWORD) PG_KEYWORD(
    ...
    RESERVED_KEYWORD) PG_KEYWORD("cursor", K_CURSOR, RESERVED_KEYWORD) PG_KEYWORD("declare", K_DECLARE,
...
static const ScanKeyword unreserved_keywords[] = {
    PG_KEYWORD("absolute", K_ABSOLUTE, UNRESERVED_KEYWORD) PG_KEYWORD("alias", K_ALIAS, UNRESERVED_KEYWORD) PG_KEYWORD(
        ...
        UNRESERVED_KEYWORD) PG_KEYWORD("forward", K_FORWARD, UNRESERVED_KEYWORD) PG_KEYWORD("hint", K_HINT,
        UNRESERVED_KEYWORD) PG_KEYWORD("immediate", K_IMMEDIATE, UNRESERVED_KEYWORD) PG_KEYWORD("info", K_INFO,
        UNRESERVED_KEYWORD) PG_KEYWORD("is", K_IS, UNRESERVED_KEYWORD) PG_KEYWORD("last", K_LAST, UNRESERVED_KEYWORD)
        PG_KEYWORD("log", K_LOG, UNRESERVED_KEYWORD) PG_KEYWORD("merge", K_MERGE, UNRESERVED_KEYWORD) PG_KEYWORD(
            "message", K_MESSAGE, UNRESERVED_KEYWORD) PG_KEYWORD("message_text", K_MESSAGE_TEXT,
            UNRESERVED_KEYWORD) PG_KEYWORD("next", K_NEXT, UNRESERVED_KEYWORD) PG_KEYWORD("no", K_NO,
                    ...
                    PG_KEYWORD("relative", K_RELATIVE, UNRESERVED_KEYWORD) PG_KEYWORD("result_oid", K_RESULT_OID,
                        ...
                        PG_KEYWORD("reverse", K_REVERSE, UNRESERVED_KEYWORD) PG_KEYWORD("row_count", K_ROW_COUNT,
                            ...
                            PG_KEYWORD("savepoint", K_SAVEPOINT, UNRESERVED_KEYWORD) PG_KEYWORD(
                                ...
                                PG_KEYWORD("sqlstate", K_SQLSTATE, UNRESERVED_KEYWORD) PG_KEYWORD("stacked", K_STACKED,
                                    UNRESERVED_KEYWORD) PG_KEYWORD("sys_refcursor", K_SYS_REFCURSOR, UNRESERVED_KEYWORD)
