 ...
 * 	 	 	 * still try to set it.
 * 	 	 	 	 */
	{(char *)"authtype", (char *)"PGAUTHTYPE", (char *)DefaultAuthtype, NULL,
	(char *)"Database-Authtype", (char *)"D", 20, -1},

	{(char *)"service", (char *)"PGSERVICE", NULL, NULL,
	(char *)"Database-Service", (char *)"", 20, -1},

	{(char *)"user", (char *)"PGUSER", NULL, NULL,
		(char *)"Database-User", (char *)"", 20,
	offsetof(struct pg_conn, pguser)},

	{(char *)"password", (char *)"PGPASSWORD", NULL, NULL,
		(char *)"Database-Password", (char *)"*", 20,
	offsetof(struct pg_conn, pgpass)},


	{(char *)"connect_timeout", (char *)"PGCONNECT_TIMEOUT", NULL, NULL,
		(char *)"Connect-timeout", (char *)"", 10,	/* strlen(INT32_MAX) == 10 */
	offsetof(struct pg_conn, connect_timeout)},

	{(char *)"dbname", (char *)"PGDATABASE", NULL, NULL,
		(char *)"Database-Name", (char *)"", 20,
	offsetof(struct pg_conn, dbName)},

	{(char *)"host", (char *)"PGHOST", NULL, NULL,
		(char *)"Database-Host", (char *)"", 40,
	offsetof(struct pg_conn, pghost)},

	{(char *)"hostaddr", (char *)"PGHOSTADDR", NULL, NULL,
		(char *)"Database-Host-IP-Address", (char *)"", 45,
	offsetof(struct pg_conn, pghostaddr)},

	{(char *)"port", (char *)"PGPORT", (char *)DEF_PGPORT_STR, NULL,
		(char *)"Database-Port", (char *)"", 6,
	offsetof(struct pg_conn, pgport)},

	{(char *)"client_encoding", (char *)"PGCLIENTENCODING", NULL, NULL,
		(char *)"Client-Encoding", (char *)"", 10,
 ...
 * 	 	 * compatibility.
 * 	 	 	 */
	{(char *)"tty", (char *)"PGTTY", (char *)DefaultTty, NULL,
		(char *)"Backend-Debug-TTY", (char *)"D", 40,
	offsetof(struct pg_conn, pgtty)},

	{(char *)"options", (char *)"PGOPTIONS", (char *)DefaultOption, NULL,
		(char *)"Backend-Options", (char *)"", 40,
	offsetof(struct pg_conn, pgoptions)},

	{(char *)"application_name", (char *)"PGAPPNAME", NULL, NULL,
		(char *)"Application-Name", (char *)"", 64,
	offsetof(struct pg_conn, appname)},

	{(char *)"fallback_application_name", NULL, NULL, NULL,
		(char *)"Fallback-Application-Name", (char *)"", 64,
	offsetof(struct pg_conn, fbappname)},

	{(char *)"keepalives", NULL, NULL, NULL,
		(char *)"TCP-Keepalives", (char *)"", 1,	/* should be just '0' or '1' */
	offsetof(struct pg_conn, keepalives)},

	{(char *)"keepalives_idle", NULL, NULL, NULL,
		(char *)"TCP-Keepalives-Idle", (char *)"", 10,	/* strlen(INT32_MAX) == 10 */
	offsetof(struct pg_conn, keepalives_idle)},

	{(char *)"keepalives_interval", NULL, NULL, NULL,
		(char *)"TCP-Keepalives-Interval", (char *)"", 10,	/* strlen(INT32_MAX) == 10 */
	offsetof(struct pg_conn, keepalives_interval)},

	{(char *)"keepalives_count", NULL, NULL, NULL,
		(char *)"TCP-Keepalives-Count", (char *)"", 10, /* strlen(INT32_MAX) == 10 */
 ...
 * 	 	 	 	 	 */
	{(char *)"sslmode", (char *)"PGSSLMODE", (char *)DefaultSSLMode, NULL,
		(char *)"SSL-Mode", (char *)"", 12,		/* sizeof("verify-full") == 12 */
	offsetof(struct pg_conn, sslmode)},

	{(char *)"sslcompression", (char *)"PGSSLCOMPRESSION", (char *)"0", NULL,
		(char *)"SSL-Compression", (char *)"", 1,
	offsetof(struct pg_conn, sslcompression)},

	{(char *)"sslcert", (char *)"PGSSLCERT", NULL, NULL,
		(char *)"SSL-Client-Cert", (char *)"", 64,
	offsetof(struct pg_conn, sslcert)},

	{(char *)"sslkey", (char *)"PGSSLKEY", NULL, NULL,
		(char *)"SSL-Client-Key", (char *)"", 64,
	offsetof(struct pg_conn, sslkey)},

	{(char *)"sslrootcert", (char *)"PGSSLROOTCERT", NULL, NULL,
		(char *)"SSL-Root-Certificate", (char *)"", 64,
	offsetof(struct pg_conn, sslrootcert)},

	{(char *)"sslcrl", (char *)"PGSSLCRL", NULL, NULL,
		(char *)"SSL-Revocation-List", (char *)"", 64,
	offsetof(struct pg_conn, sslcrl)},

	{(char *)"requirepeer", (char *)"PGREQUIREPEER", NULL, NULL,
		(char *)"Require-Peer", (char *)"", 10,
 ...
 * 	 	 	 */
	...
	{(char *)"krbsrvname", (char *)"PGKRBSRVNAME", (char *)PG_KRB_SRVNAM, NULL,
		(char *)"Kerberos-service-name", (char *)"", 20,
	offsetof(struct pg_conn, krbsrvname)},


	{(char *)"replication", NULL, NULL, NULL,
		(char *)"Replication", (char *)"D", 5,
