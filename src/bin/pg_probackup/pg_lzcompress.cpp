 ...
 *  Acknowledgments:
 *
 *  any thanks to Adisak Pochanayon, who's article about SLZ
              ...
              const PGLZ_Strategy *strategy)
{
     ...
     */
    rc = memset_s(hist_start, hashsz * sizeof(int16), 0, hashsz * sizeof(int16));
    securec_check_c(rc, "\0", "\0");

    /*
     * Compress the source directly into the output buffer.
     */
    return compress(source, slen, dest, strategy,
