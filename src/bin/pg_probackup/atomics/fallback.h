...
extern void pg_atomic_init_u32_impl(volatile pg_atomic_uint32_local *ptr, uint32 val_);

#define PG_HAVE_ATOMIC_WRITE_U32
extern void pg_atomic_write_u32_impl(volatile pg_atomic_uint32_local *ptr, uint32 val);
...
extern void pg_atomic_init_u64_impl(volatile pg_atomic_uint64_local *ptr, uint64 val_);
