...
readInstanceConfigFile(const char *instance_name)
{
	...
	ConfigOption instance_options[] =
	{
		...
		{
			's', 'D', "pgdata",
			&instance->pgdata, SOURCE_CMD, (OptionSource)0,
			OPTION_INSTANCE_GROUP, 0, option_get_value
		},
		{
			'U', 200, "system-identifier",
			&instance->system_identifier, SOURCE_FILE_STRICT, (OptionSource)0,
			OPTION_INSTANCE_GROUP, 0, option_get_value
		},
	#if PG_VERSION_NUM >= 110000
		{
		...
		{
			's', 'E', "external-dirs",
			&instance->external_dir_str, SOURCE_CMD, (OptionSource)0,
			OPTION_INSTANCE_GROUP, 0, option_get_value
		},
		/* Connection options */
		{
			's', 'd', "pgdatabase",
			&instance->conn_opt.pgdatabase, SOURCE_CMD, (OptionSource)0,
			OPTION_CONN_GROUP, 0, option_get_value
		},
		{
			's', 'h', "pghost",
			&instance->conn_opt.pghost, SOURCE_CMD, (OptionSource)0,
			OPTION_CONN_GROUP, 0, option_get_value
		},
		{
			's', 'p', "pgport",
			&instance->conn_opt.pgport, SOURCE_CMD, (OptionSource)0,
			OPTION_CONN_GROUP, 0, option_get_value
		},
		{
			's', 'U', "pguser",
			&instance->conn_opt.pguser, SOURCE_CMD, (OptionSource)0,
			OPTION_CONN_GROUP, 0, option_get_value
		},
		/* Archive options */
		{
		...
		{
			's', 211, "restore-command",
			&instance->restore_command, SOURCE_CMD, (OptionSource)0,
			OPTION_ARCHIVE_GROUP, 0, option_get_value
		},
		...
		/* Logging options */
		{
			...
			&log_level_console, SOURCE_CMD, (OptionSource)0,
			OPTION_LOG_GROUP, 0, option_get_value
		},
		{
			's', 213, "log-level-file",
			&log_level_file, SOURCE_CMD, (OptionSource)0,
			OPTION_LOG_GROUP, 0, option_get_value
		},
		{
			's', 214, "log-filename",
			&instance->logger.log_filename, SOURCE_CMD, (OptionSource)0,
			OPTION_LOG_GROUP, 0, option_get_value
		},
		{
			's', 215, "error-log-filename",
			&instance->logger.error_log_filename, SOURCE_CMD, (OptionSource)0,
			OPTION_LOG_GROUP, 0, option_get_value
		},
		{
			's', 216, "log-directory",
			&instance->logger.log_directory, SOURCE_CMD, (OptionSource)0,
			OPTION_LOG_GROUP, 0, option_get_value
		},
		{
			'U', 217, "log-rotation-size",
		...
		{
			'u', 219, "retention-redundancy",
			&instance->retention_redundancy, SOURCE_CMD, (OptionSource)0,
			OPTION_RETENTION_GROUP, 0, option_get_value
		},
		{
			'u', 220, "retention-window",
			&instance->retention_window, SOURCE_CMD, (OptionSource)0,
			OPTION_RETENTION_GROUP, 0, option_get_value
		},
		{
			'u', 221, "wal-depth",
			&instance->wal_depth, SOURCE_CMD, (OptionSource)0,
			OPTION_RETENTION_GROUP, 0, option_get_value
		},
		/* Compression options */
		{
			's', 222, "compress-algorithm",
			&compress_alg, SOURCE_CMD, (OptionSource)0,
			OPTION_LOG_GROUP, 0, option_get_value
		},
		{
			'u', 223, "compress-level",
			&instance->compress_level, SOURCE_CMD, (OptionSource)0,
			OPTION_COMPRESS_GROUP, 0, option_get_value
		},
		/* Remote backup options */
		{
			's', 224, "remote-proto",
			&instance->remote.proto, SOURCE_CMD, (OptionSource)0,
			OPTION_REMOTE_GROUP, 0, option_get_value
		},
		{
			's', 225, "remote-host",
			&instance->remote.host, SOURCE_CMD, (OptionSource)0,
			OPTION_REMOTE_GROUP, 0, option_get_value
		},
		{
			's', 226, "remote-port",
			&instance->remote.port, SOURCE_CMD, (OptionSource)0,
			OPTION_REMOTE_GROUP, 0, option_get_value
		},
		{
			's', 227, "remote-path",
			&instance->remote.path, SOURCE_CMD, (OptionSource)0,
			OPTION_REMOTE_GROUP, 0, option_get_value
		},
		{
			's', 228, "remote-user",
			&instance->remote.user, SOURCE_CMD, (OptionSource)0,
			OPTION_REMOTE_GROUP, 0, option_get_value
		},
		{
			's', 229, "ssh-options",
			&instance->remote.ssh_options, SOURCE_CMD, (OptionSource)0,
			OPTION_REMOTE_GROUP, 0, option_get_value
		},
		{
			's', 230, "ssh-config",
			&instance->remote.ssh_config, SOURCE_CMD, (OptionSource)0,
			OPTION_REMOTE_GROUP, 0, option_get_value
		},
		{ 0 }
	};
