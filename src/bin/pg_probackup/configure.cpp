...
ConfigOption instance_options[] =
{
    ...
    {
        's', 'D', "pgdata",
        &instance_config.pgdata, SOURCE_CMD, (OptionSource)0,
        OPTION_INSTANCE_GROUP, 0, option_get_value
    },
    {
        'U', 200, "system-identifier",
        &instance_config.system_identifier, SOURCE_FILE_STRICT, (OptionSource)0,
        OPTION_INSTANCE_GROUP, 0, option_get_value
    },
    ...
    {
        's', 'E', "external-dirs",
        &instance_config.external_dir_str, SOURCE_CMD, (OptionSource)0,
        OPTION_INSTANCE_GROUP, 0, option_get_value
    },
    /* Connection options */
    {
        's', 'd', "pgdatabase",
        &instance_config.conn_opt.pgdatabase, SOURCE_CMD, (OptionSource)0,
        OPTION_CONN_GROUP, 0, option_get_value
    },
    {
        's', 'h', "pghost",
        &instance_config.conn_opt.pghost, SOURCE_CMD, (OptionSource)0,
        OPTION_CONN_GROUP, 0, option_get_value
    },
    {
        's', 'p', "pgport",
        &instance_config.conn_opt.pgport, SOURCE_CMD, (OptionSource)0,
        OPTION_CONN_GROUP, 0, option_get_value
    },
    {
        's', 'U', "pguser",
        &instance_config.conn_opt.pguser, SOURCE_CMD, (OptionSource)0,
        OPTION_CONN_GROUP, 0, option_get_value
    },
    /* Archive options */
    {
    ...
    {
        's', 208, "archive-host",
        &instance_config.archive.host, SOURCE_CMD, (OptionSource)0,
        OPTION_ARCHIVE_GROUP, 0, option_get_value
    },
    {
        's', 209, "archive-port",
        &instance_config.archive.port, SOURCE_CMD, (OptionSource)0,
        OPTION_ARCHIVE_GROUP, 0, option_get_value
    },
    {
        's', 210, "archive-user",
        &instance_config.archive.user, SOURCE_CMD, (OptionSource)0,
        OPTION_ARCHIVE_GROUP, 0, option_get_value
    },
    {
    ...
    /* Logging options */
    {
        ...
        (void *)assign_log_level_console, SOURCE_CMD, (OptionSource)0,
        OPTION_LOG_GROUP, 0, get_log_level_console
    },
    {
        'f', 213, "log-level-file",
        (void *)assign_log_level_file, SOURCE_CMD, (OptionSource)0,
        OPTION_LOG_GROUP, 0, get_log_level_file
    },
    {
        's', 214, "log-filename",
        &instance_config.logger.log_filename, SOURCE_CMD, (OptionSource)0,
        OPTION_LOG_GROUP, 0, option_get_value
    },
    {
        's', 215, "error-log-filename",
        &instance_config.logger.error_log_filename, SOURCE_CMD, (OptionSource)0,
        OPTION_LOG_GROUP, 0, option_get_value
    },
    {
        's', 216, "log-directory",
        &instance_config.logger.log_directory, SOURCE_CMD, (OptionSource)0,
        OPTION_LOG_GROUP, 0, option_get_value
    },
    {
    ...
    /* Retention options */
    {
        ...
        &instance_config.retention_redundancy, SOURCE_CMD, (OptionSource)0,
        OPTION_RETENTION_GROUP, 0, option_get_value
    },
    {
        'u', 220, "retention-window",
        &instance_config.retention_window, SOURCE_CMD, (OptionSource)0,
        OPTION_RETENTION_GROUP, 0, option_get_value
    },
    {
        'u', 221, "wal-depth",
        &instance_config.wal_depth, SOURCE_CMD, (OptionSource)0,
        OPTION_RETENTION_GROUP, 0, option_get_value
    },
    /* Compression options */
    {
        'f', 222, "compress-algorithm",
        (void *)assign_compress_alg, SOURCE_CMD, (OptionSource)0,
        OPTION_COMPRESS_GROUP, 0, get_compress_alg
    },
    {
        'u', 223, "compress-level",
        &instance_config.compress_level, SOURCE_CMD, (OptionSource)0,
        OPTION_COMPRESS_GROUP, 0, option_get_value
    },
    /* Remote backup options */
    {
        's', 224, "remote-proto",
        &instance_config.remote.proto, SOURCE_CMD, (OptionSource)0,
        OPTION_REMOTE_GROUP, 0, option_get_value
    },
    {
        's', 225, "remote-host",
        &instance_config.remote.host, SOURCE_CMD, (OptionSource)0,
        OPTION_REMOTE_GROUP, 0, option_get_value
    },
    {
        's', 226, "remote-port",
        &instance_config.remote.port, SOURCE_CMD, (OptionSource)0,
        OPTION_REMOTE_GROUP, 0, option_get_value
    },
    {
        's', 227, "remote-path",
        &instance_config.remote.path, SOURCE_CMD, (OptionSource)0,
        OPTION_REMOTE_GROUP, 0, option_get_value
    },
    {
        's', 228, "remote-user",
        &instance_config.remote.user, SOURCE_CMD, (OptionSource)0,
        OPTION_REMOTE_GROUP, 0, option_get_value
    },
    {
        's', 229, "ssh-options",
        &instance_config.remote.ssh_options, SOURCE_CMD, (OptionSource)0,
        OPTION_REMOTE_GROUP, 0, option_get_value
    },
    {
        's', 230, "ssh-config",
...
{
    errno_t rc = 0;
    rc = memset_s(config, sizeof(InstanceConfig),0, sizeof(InstanceConfig));
...
readInstanceConfigFile(const char *instance_name)
{
    ...
    ConfigOption instance_options[] =
    {
        /* Instance options */
        {
            's', 'D', "pgdata", &instance->pgdata, SOURCE_CMD, (OptionSource)0,
            OPTION_INSTANCE_GROUP, 0, option_get_value
        },
        {
            'U', 200, "system-identifier", &instance->system_identifier, SOURCE_FILE_STRICT, (OptionSource)0,
            OPTION_INSTANCE_GROUP, 0, option_get_value
        },
    #if PG_VERSION_NUM >= 110000
        {
            'u', 201, "xlog-seg-size", &instance->xlog_seg_size, SOURCE_FILE_STRICT, 0,
            OPTION_INSTANCE_GROUP, 0, option_get_value
        },
    #endif
        {
            's', 'E', "external-dirs", &instance->external_dir_str, SOURCE_CMD, (OptionSource)0,
            OPTION_INSTANCE_GROUP, 0, option_get_value
        },
        /* Connection options */
        {
            's', 'd', "pgdatabase", &instance->conn_opt.pgdatabase, SOURCE_CMD, (OptionSource)0,
            OPTION_CONN_GROUP, 0, option_get_value
        },
        {
            's', 'h', "pghost", &instance->conn_opt.pghost, SOURCE_CMD, (OptionSource)0,
            OPTION_CONN_GROUP, 0, option_get_value
        },
        {
            's', 'p', "pgport", &instance->conn_opt.pgport, SOURCE_CMD, (OptionSource)0,
            OPTION_CONN_GROUP, 0, option_get_value
        },
        {
            's', 'U', "pguser", &instance->conn_opt.pguser, SOURCE_CMD, (OptionSource)0,
            OPTION_CONN_GROUP, 0, option_get_value
        },
        /* Archive options */
        {
            'u', 207, "archive-timeout", &instance->archive_timeout, SOURCE_CMD, SOURCE_DEFAULT,
            OPTION_ARCHIVE_GROUP, OPTION_UNIT_S, option_get_value
        },
        {
            's', 208, "archive-host", &instance_config.archive.host, SOURCE_CMD, (OptionSource)0,
            OPTION_ARCHIVE_GROUP, 0, option_get_value
        },
        {
            's', 209, "archive-port", &instance_config.archive.port, SOURCE_CMD, (OptionSource)0,
            OPTION_ARCHIVE_GROUP, 0, option_get_value
        },
        {
            's', 210, "archive-user", &instance_config.archive.user, SOURCE_CMD, (OptionSource)0,
            OPTION_ARCHIVE_GROUP, 0, option_get_value
        },
        {
            's', 211, "restore-command", &instance->restore_command, SOURCE_CMD, (OptionSource)0,
            OPTION_ARCHIVE_GROUP, 0, option_get_value
        },
        ...
        /* Logging options */
        {
            's', 212, "log-level-console", &log_level_console, SOURCE_CMD, (OptionSource)0,
            OPTION_LOG_GROUP, 0, option_get_value
        },
        {
            's', 213, "log-level-file", &log_level_file, SOURCE_CMD, (OptionSource)0,
            OPTION_LOG_GROUP, 0, option_get_value
        },
        {
            's', 214, "log-filename", &instance->logger.log_filename, SOURCE_CMD, (OptionSource)0,
            OPTION_LOG_GROUP, 0, option_get_value
        },
        {
            's', 215, "error-log-filename", &instance->logger.error_log_filename, SOURCE_CMD, (OptionSource)0,
            OPTION_LOG_GROUP, 0, option_get_value
        },
        {
            's', 216, "log-directory", &instance->logger.log_directory, SOURCE_CMD, (OptionSource)0,
            OPTION_LOG_GROUP, 0, option_get_value
        },
        {
            'U', 217, "log-rotation-size", &instance->logger.log_rotation_size, SOURCE_CMD, SOURCE_DEFAULT,
            OPTION_LOG_GROUP, OPTION_UNIT_KB, option_get_value
        },
        {
            'U', 218, "log-rotation-age", &instance->logger.log_rotation_age, SOURCE_CMD, SOURCE_DEFAULT,
            OPTION_LOG_GROUP, OPTION_UNIT_MS, option_get_value
        },
        /* Retention options */
        {
            'u', 219, "retention-redundancy", &instance->retention_redundancy, SOURCE_CMD, (OptionSource)0,
            OPTION_RETENTION_GROUP, 0, option_get_value
        },
        {
            'u', 220, "retention-window", &instance->retention_window, SOURCE_CMD, (OptionSource)0,
            OPTION_RETENTION_GROUP, 0, option_get_value
        },
        {
            'u', 221, "wal-depth", &instance->wal_depth, SOURCE_CMD, (OptionSource)0,
            OPTION_RETENTION_GROUP, 0, option_get_value
        },
        /* Compression options */
        {
            's', 222, "compress-algorithm", &compress_alg, SOURCE_CMD, (OptionSource)0,
            OPTION_LOG_GROUP, 0, option_get_value
        },
        {
            'u', 223, "compress-level", &instance->compress_level, SOURCE_CMD, (OptionSource)0,
            OPTION_COMPRESS_GROUP, 0, option_get_value
        },
        /* Remote backup options */
        {
            's', 224, "remote-proto", &instance->remote.proto, SOURCE_CMD, (OptionSource)0,
            OPTION_REMOTE_GROUP, 0, option_get_value
        },
        {
            's', 225, "remote-host", &instance->remote.host, SOURCE_CMD, (OptionSource)0,
            OPTION_REMOTE_GROUP, 0, option_get_value
        },
        {
            's', 226, "remote-port", &instance->remote.port, SOURCE_CMD, (OptionSource)0,
            OPTION_REMOTE_GROUP, 0, option_get_value
        },
        {
            's', 227, "remote-path", &instance->remote.path, SOURCE_CMD, (OptionSource)0,
            OPTION_REMOTE_GROUP, 0, option_get_value
        },
        {
            's', 228, "remote-user", &instance->remote.user, SOURCE_CMD, (OptionSource)0,
            OPTION_REMOTE_GROUP, 0, option_get_value
        },
        {
            's', 229, "ssh-options", &instance->remote.ssh_options, SOURCE_CMD, (OptionSource)0,
            OPTION_REMOTE_GROUP, 0, option_get_value
        },
        {
    ...
    nRet = snprintf_s(instance->backup_instance_path,MAXPGPATH,MAXPGPATH - 1, "%s/%s/%s",
            backup_path, BACKUPS_DIR, instance_name);
    securec_check_ss_c(nRet, "\0", "\0");
    canonicalize_path(instance->backup_instance_path);

    nRet = snprintf_s(instance->arclog_path,MAXPGPATH,MAXPGPATH - 1, "%s/%s/%s",
...
{
    return gs_pstrdup(deparse_log_level(instance_config.logger.log_level_console));
}

static char *
get_log_level_file(ConfigOption *opt)
{
    return gs_pstrdup(deparse_log_level(instance_config.logger.log_level_file));
}

static char *
get_compress_alg(ConfigOption *opt)
{
    return gs_pstrdup(deparse_compress_alg(instance_config.compress_alg));
}
