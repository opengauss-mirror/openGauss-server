...
static char** complete_from_variables(const char* text, const char* prefix, const char* suffix);
...
/* ALTER */
			  ...
			  pg_strcasecmp(prev3_wd, "FUNCTION") == 0))
	{
		...
		{
			char *tmp_buf = (char *)malloc(strlen(Query_for_list_of_arguments) + strlen(prev2_wd));
...
/* TODO:  \dc \dd \dl */
	...
	/* free storage */
	{
		...
		for (i = 0; i < (int)lengthof(previous_words); i++)
