...
static char **PsqlCompletion(const char *text, int start, int end)
{
    ...
    char *previousWords[6];

    /* For compactness, we use these macros to reference previousWords[]. */
...
#define PREV6_WD (previousWords[5])
    ...
    /* ALTER AGGREGATE,FUNCTION <name> */
        ...
        (pg_strcasecmp(PREV2_WD, "AGGREGATE") == 0 || pg_strcasecmp(PREV2_WD, "FUNCTION") == 0))
        COMPLETE_WITH_CONST("(");
    /* ALTER AGGREGATE,FUNCTION <name> (...) */
    else if (pg_strcasecmp(PREV4_WD, "ALTER") == 0 &&
        (pg_strcasecmp(PREV3_WD, "AGGREGATE") == 0 || pg_strcasecmp(PREV3_WD, "FUNCTION") == 0)) {
        if (PREV_WD[strlen(PREV_WD) - 1] == ')') {
            static const char *const listAlterAgg[] = {
    ...
    /* ALTER SCHEMA <name> */
        ...
        static const char *const listAlterGen[] = {
    ...
    /* ALTER EXTENSION <name> */
        ...
        static const char *const listAlterExtension[] = {
    ...
    /* ALTER FOREIGN */
        ...
        static const char *const listAlterForeign[] = {
    ...
    /* ALTER FOREIGN DATA WRAPPER <name> */
        ...
        static const char *const listAlterFdw[] = {
    ...
    /* ALTER FOREIGN TABLE <name> */
        ...
        static const char *const listAlterForeignTable[] = {
    ...
    /* ALTER INDEX <name> */
        ...
        static const char *const listAlterindex[] = {
    ...
    /* ALTER INDEX <name> SET */
        ...
        static const char *const listAlterindexset[] = {
            "(", "TABLESPACE", NULL};
    ...
    /* ALTER INDEX <foo> SET|RESET ( */
        ...
        static const char *const listIndexOptions[] = {
    ...
    /* ALTER LANGUAGE <name> */
        ...
        static const char *const listAlterLanguage[] = {
            "OWNER TO", "RENAME TO", NULL};
    ...
    /* ALTER LARGE OBJECT <oid> */
        ...
        static const char *const listAlterLargeObject[] = {
            "OWNER TO", NULL};
    ...
    /* ALTER DEFAULT PRIVILEGES */
        ...
        static const char *const listAlterDefaultPrivileges[] = {
    ...
    /* ALTER DEFAULT PRIVILEGES FOR */
        ...
        static const char *const listAlterDefaultPrivileges_FOR[] = {
            "ROLE", "USER", NULL};
    ...
    /* ALTER DEFAULT PRIVILEGES { FOR ROLE ... | IN SCHEMA ... } */
        ...
        static const char *const listAlterDefaultPrivilegesRest[] = {
            "GRANT", "REVOKE", NULL};
    ...
    /* ALTER DOMAIN <sth> DROP */
        ...
        static const char *const listAlterDomain2[] = {
    ...
    /* ALTER DOMAIN <sth> SET */
        ...
        pg_strcasecmp(PREV_WD, "SET") == 0) {
        static const char *const listAlterDomain3[] = {
    ...
    /* ALTER SEQUENCE <name> NO */
        ...
        static const char *const listAlterSequencE2[] = {
    ...
    /* ALTER VIEW <name> */
        ...
        static const char *const listAlterview[] = {
    ...
    /* ALTER TABLE xxx ENABLE */
        ...
        static const char *const listAlterEnable[] = {
        ...
        static const char *const listAlterEnablE2[] = {
            "RULE", "TRIGGER", NULL};

        COMPLETE_WITH_LIST(listAlterEnablE2);
    } else if (pg_strcasecmp(PREV4_WD, "ALTER") == 0 && pg_strcasecmp(PREV3_WD, "TABLE") == 0 &&
        pg_strcasecmp(PREV_WD, "DISABLE") == 0) {
        static const char *const listAlterDisable[] = {
            "RULE", "TRIGGER", NULL};
    ...
    /* If we have TABLE <sth> DROP, provide COLUMN or CONSTRAINT */
        ...
        static const char *const listTableDrop[] = {
    ...
    /* ALTER TABLE ALTER [COLUMN] <foo> */
        ...
        static const char *const listColumnAlter[] = {
    ...
    /* ALTER TABLE ALTER [COLUMN] <foo> SET */
        ...
        pg_strcasecmp(PREV_WD, "SET") == 0) {
        static const char *const listColumnSet[] = {
    ...
    /* ALTER TABLE ALTER [COLUMN] <foo> SET ( */
        ...
        static const char *const listColumnOptions[] = {
    ...
    /* ALTER TABLE ALTER [COLUMN] <foo> SET STORAGE */
        ...
        static const char *const listColumnStorage[] = {
    ...
    /* ALTER TABLE ALTER [COLUMN] <foo> DROP */
        ...
        (pg_strcasecmp(PREV5_WD, "TABLE") == 0 && pg_strcasecmp(PREV3_WD, "ALTER") == 0)) &&
        pg_strcasecmp(PREV_WD, "DROP") == 0) {
        static const char *const listColumnDrop[] = {
    ...
    /* If we have TABLE <sth> SET, provide WITHOUT,TABLESPACE and SCHEMA */
        ...
        static const char *const listTableSet[] = {
    ...
    /* If we have TABLE <sth> SET WITHOUT provide CLUSTER or OIDS */
        ...
        static const char *const listTableSet2[] = {
            "CLUSTER", "OIDS", NULL};
    ...
    /* ALTER TABLESPACE <foo> with RENAME TO, OWNER TO, SET, RESET */
        ...
        static const char *const listAlterTspc[] = {
    ...
    /* ALTER TABLESPACE <foo> SET|RESET ( */
        ...
        (pg_strcasecmp(PREV2_WD, "SET") == 0 || pg_strcasecmp(PREV2_WD, "RESET") == 0) &&
        pg_strcasecmp(PREV_WD, "(") == 0) {
        static const char *const listTablespaceOptions[] = {
    ...
    /* ALTER TEXT SEARCH */
        ...
        static const char *const listAlterTextSearch[] = {
        ...
        static const char *const listAlterTextSearcH2[] = {
        ...
        static const char *const listAlterTextSearch3[] = {
            "OWNER TO", "RENAME TO", "SET SCHEMA", NULL};
    ...
    /* complete ALTER GROUP <foo> */
        ...
        static const char *const listAlterGroup[] = {
    ...
    /* BEGIN, END, ABORT */
        ...
        static const char *const listTrans[] = {
    ...
    /* COMMIT */
        ...
        static const char *const listCommit[] = {
    ...
    /* COMMENT */
        ...
        static const char *const listTrans2[] = {
            "DATA WRAPPER", "TABLE", NULL};
    ...
    /* If we have COPY|BINARY <sth>, complete it with "TO" or "FROM" */
        ...
        static const char *const listFromTo[] = {
            "FROM", "TO", NULL};
    ...
    /* Handle COPY|BINARY <sth> FROM|TO filename CSV */
        ...
        static const char *const listCsv[] = {
    ...
    /* CREATE FOREIGN */
        ...
        static const char *const listCreateForeign[] = {
            "DATA WRAPPER", "TABLE", NULL};
    ...
    /* CREATE FOREIGN DATA WRAPPER */
        ...
        pg_strcasecmp(PREV3_WD, "DATA") == 0 && pg_strcasecmp(PREV2_WD, "WRAPPER") == 0) {
        static const char *const listCreateForeignDataWrapper[] = {
    ...
    /* If we have CREATE|UNIQUE INDEX <sth>, then add "ON" or "CONCURRENTLY" */
        ...
        static const char *const listCreateIndex[] = {
     ...
     */
        ...
        static const char *const listCreateIndex2[] = {
            "(", "USING", NULL};
    ...
    /* Complete "RULE * AS ON" with SELECT|UPDATE|DELETE|INSERT */
        ...
        pg_strcasecmp(PREV_WD, "ON") == 0) {
        static const char *const ruleEvents[] = {
    ...
    /* Complete "CREATE TEMP/TEMPORARY" with the possible temp objects */
        ...
        static const char *const listTemp[] = {
    ...
    /* CREATE TABLESPACE */
        ...
        static const char *const listCreateTablespace[] = {
            "OWNER", "LOCATION", NULL};
    ...
    /* CREATE TEXT SEARCH */
        ...
        pg_strcasecmp(PREV_WD, "SEARCH") == 0) {
        static const char *const listCreateTextSearch[] = {
            "CONFIGURATION", "DICTIONARY", "PARSER", "TEMPLATE", NULL};
    ...
    /* complete CREATE TRIGGER <name> with BEFORE,AFTER */
        ...
        static const char *const listCreateTrigger[] = {
    ...
    /* complete CREATE TRIGGER <name> BEFORE,AFTER with an event */
        ...
        static const char *const listCreateTriggerEvents[] = {
    ...
    /* complete CREATE TRIGGER <name> BEFORE,AFTER sth with OR,ON */
        ...
        static const char *const listCreateTrigger2[] = {
            "ON", "OR", NULL};
    ...
    /* complete CREATE ROLE,USER,GROUP <name> IN with ROLE,GROUP */
        ...
        static const char *const listCreateRole3[] = {
            "GROUP", "ROLE", NULL};
    ...
    /* DECLARE */
        ...
        static const char *const listDeclare[] = {
    ...
    /* Complete DELETE FROM <table> */
        ...
        static const char *const listDelete[] = {
    ...
    /* DISCARD */
        ...
        static const char *const listDiscard[] = {
            "ALL", "PLANS", "TEMP", NULL};
     ...
     */
        ...
        static const char *const listDo[] = {
            "LANGUAGE", NULL};
    ...
    /* Complete FETCH with one of FORWARD, BACKWARD, RELATIVE */
        ...
        static const char *const listFetch1[] = {
     ...
     */
        ...
        static const char *const listFromin[] = {
            "FROM", "IN", NULL};
     ...
     */
        ...
        static const char *const listPrivilegeForeign[] = {
     ...
     */
        ...
        static const char *const listInsert[] = {
    ...
    /* PREPARE xx AS */
        ...
        static const char *const listPrepare[] = {
            "SELECT", "UPDATE", "INSERT", "DELETE", NULL};
    ...
    /* REINDEX */
        ...
        static const char *const listReindex[] = {
    ...
    /* SECURITY LABEL */
        ...
        static const char *const listSecurityLabelPreposition[] = {
            "ON", "FOR"};
    ...
    /* Complete SET CONSTRAINTS <foo> with DEFERRED|IMMEDIATE */
        ...
        static const char *const constraintList[] = {
     ...
     */
        ...
        COMPLETE_WITH_SCHEMA_QUERY(Query_for_list_of_tables, " UNION SELECT 'FULL'"
            " UNION SELECT 'FREEZE'"
            " UNION SELECT 'ANALYZE'"
            " UNION SELECT 'VERBOSE'");
    else if (pg_strcasecmp(PREV2_WD, "VACUUM") == 0 &&
        (pg_strcasecmp(PREV_WD, "FULL") == 0 || pg_strcasecmp(PREV_WD, "FREEZE") == 0))
        COMPLETE_WITH_SCHEMA_QUERY(Query_for_list_of_tables, " UNION SELECT 'ANALYZE'"
            " UNION SELECT 'VERBOSE'");
