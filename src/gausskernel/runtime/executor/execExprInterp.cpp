...
//			Assert((scanslot->tts_tupslotTableAm == TAM_HEAP) ? (attnum >= 0 && attnum < scanslot->tts_nvalid) : (attnum >= 0));
        ...
        EEO_CASE(EEOP_AGG_INIT_TRANS)
        {
            ...
            pergroup =
                &aggstate
                     ->all_pergroups[op->d.agg_init_trans.setoff * aggstate->numtrans + op->d.agg_init_trans.transno];
        ...
        EEO_CASE(EEOP_AGG_PLAIN_TRANS_BYVAL)
        {
            ...
            pergroup = &aggstate->all_pergroups[op->d.agg_trans.setoff * aggstate->numtrans + op->d.agg_trans.transno];
