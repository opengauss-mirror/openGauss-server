...
NON_EXEC_STATIC void PgArchiverMain(knl_thread_arg* arg)
{
    ...
    MemoryContext archiveContext = NULL;
    ...
    /* initialize memory context for archive thread and switch to this context */
    archiveContext = AllocSetContextCreate(t_thrd.top_mem_cxt, "Archive", ALLOCSET_DEFAULT_MINSIZE,
        ALLOCSET_DEFAULT_INITSIZE, ALLOCSET_DEFAULT_MAXSIZE);
    (void)MemoryContextSwitchTo(archiveContext);
    /*
