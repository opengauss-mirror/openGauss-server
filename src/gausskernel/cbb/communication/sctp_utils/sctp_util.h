 ...
 *
 * IDENTIFICATION
 *    src/gausskernel/cbb/communication/sctp_utils/sctp_util.h
 *
 * -------------------------------------------------------------------------
 */
...
typedef enum {
    SCTP_PKG_TYPE_UNKNOW,
    SCTP_PKG_TYPE_CONNECT,
    SCTP_PKG_TYPE_ACCEPT,
    SCTP_PKG_TYPE_DELAY_REQUEST,
    SCTP_PKG_TYPE_DELAY_REPLY,
    SCTP_PKG_TYPE_MAX
} sctp_package_type;
