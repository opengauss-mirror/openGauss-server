 ...
 * -------------------------------------------------------------------------
 *
 * group_synchronous_redo_log_handler.h
 *    Implements a group commit redo log.
 *
 * IDENTIFICATION
 *    src/gausskernel/storage/mot/core/system/transaction_logger/
 *        group_synchronous_redo_log/group_synchronous_redo_log_handler.h
 *
 * -------------------------------------------------------------------------
 */

#ifndef GROUP_SYNCHRONOUS_REDO_LOG_HANDLER_H
#define GROUP_SYNCHRONOUS_REDO_LOG_HANDLER_H
...
public:
    ...
    inline uint64_t GetGroupCommitSize()
    {
...
#endif /* GROUP_SYNCHRONOUS_REDO_LOG_HANDLER_H */
