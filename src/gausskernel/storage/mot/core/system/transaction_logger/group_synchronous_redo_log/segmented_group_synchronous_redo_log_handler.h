 ...
 * -------------------------------------------------------------------------
 *
 * segmented_group_synchronous_redo_log_handler.h
 *    Implements a per-numa group commit redo log.
 *
 * IDENTIFICATION
 *    src/gausskernel/storage/mot/core/system/transaction_logger/
 *        group_synchronous_redo_log/segmented_group_synchronous_redo_log_handler.h
 *
 * -------------------------------------------------------------------------
 */

#ifndef SEGMENTED_GROUP_SYNCHRONOUS_REDO_LOG_HANDLER_H
#define SEGMENTED_GROUP_SYNCHRONOUS_REDO_LOG_HANDLER_H
...
#endif /* SEGMENTED_GROUP_SYNCHRONOUS_REDO_LOG_HANDLER_H */
