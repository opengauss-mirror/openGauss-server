...
void GroupSyncRedoLogHandler::CloseGroup(std::shared_ptr<CommitGroup> group)
{
    ...
    (void)std::atomic_compare_exchange_weak(&m_currentGroup, &group, nullGroup);
