 ...
 *
 * IDENTIFICATION
 *    src/gausskernel/storage/mot/core/src/memory/mm_def.h
 *
 * -------------------------------------------------------------------------
 */
...
#define L1_ALIGN(size) MM_ALIGN(size, L1_CACHE_LINE)
 ...
 */
#define L1_ALIGNED_PTR(P) ((((uint64_t)(P)) + L1_CACHE_LINE - 1) / L1_CACHE_LINE * L1_CACHE_LINE)
