...
print $c "extern const char *const MainLWLockNames[] = {";
...
while (<$lwlocknames>)
{
	...
	print $h "#define $lockname (&t_thrd.shemem_ptr_cxt.mainLWLockArray[$lockidx].lock)\n";
}
...
rename($ctmp, 'lwlocknames.cpp') || die "rename: $ctmp: $!";
