...
bool ConstructUstoreVerifyParam(uint32 module, VerifyLevel vLevel, char *paramSt, Relation rel, Page page,
    BlockNumber blk, OffsetNumber offnum, TupleDesc tupDesc, GPIScanDesc gpiScan, XLogRecPtr lastestRedo,
    undo::UndoZone *uZone, undo::TransactionSlot *slot, int process)
{
    errno_t rc = EOK;
