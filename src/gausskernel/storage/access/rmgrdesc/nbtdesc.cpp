...
void btree_desc(StringInfo buf, XLogReaderState* record)
{
    ...
    switch (info) {
        ...
        case XLOG_BTREE_SPLIT_L: {
            ...
            appendStringInfo(buf, "level %u; firstright %u; new off %u",
                xlrec->level, (uint32)xlrec->firstright, (uint32)xlrec->newitemoff);
            break;
        }
        ...
        case XLOG_BTREE_DELETE_PAGE: {
            ...
            appendStringInfo(buf,
                "left %u; right %u; btpo_xact " XID_FMT "; parent off %u",
                xlrec->leftblk,
                xlrec->rightblk,
                xlrec->btpo_xact,
                (uint32)xlrec->poffset);
            break;
        }
        case XLOG_BTREE_DELETE_PAGE_META: {
            xl_btree_delete_page* xlrec = (xl_btree_delete_page*)rec;

            appendStringInfo(buf, "delete page meta: ");
            appendStringInfo(buf,
                "left %u; right %u; btpo_xact " XID_FMT "; parent off %u",
                xlrec->leftblk,
                xlrec->rightblk,
        ...
        case XLOG_BTREE_DELETE_PAGE_HALF: {
            ...
            appendStringInfo(buf, "delete page half: ");
            appendStringInfo(buf,
                "left %u; right %u; btpo_xact " XID_FMT "; parent off %u",
                xlrec->leftblk,
                xlrec->rightblk,
        ...
        case XLOG_BTREE_REUSE_PAGE: {
            ...
            if (bucket_id == -1) {
                appendStringInfo(buf,
                    "reuse_page: rel %u/%u/%u; latestRemovedXid " XID_FMT,
                    xlrec->node.spcNode,
                    xlrec->node.dbNode,
                    xlrec->node.relNode,
                ...
                appendStringInfo(buf,
                    "reuse_page: rel %u/%u/%u/%d; latestRemovedXid " XID_FMT,
                    xlrec->node.spcNode,
                    xlrec->node.dbNode,
                    xlrec->node.relNode,
                    bucket_id,
