...
static void alter_masking_actions(const masking_actions_set actions_to_remove,
    const masking_actions_set actions_to_update, const masking_actions_set actions_to_add,
    const Oid policyOid, const Datum curtime, masking_actions_set* existing_actions,
