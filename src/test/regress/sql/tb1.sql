...
--增加唯一约束
alter table tb1 add constraint tb1_uk1 unique(col_int,col_bigint);
--全局索引
create index idx_tbl_global_01 on tb1(col_tinyint,col_smallint desc,col_numeric,col_decimal) tablespace tbs_user_default;
create index idx_tbl_global_02 on tb1(col_integer asc,col_date,col_interval1,col_bitn) tablespace tbs_user_default;
create index idx_tbl_global_03 on tb1(col_bigint desc,col_varchar asc,col_timestamp2 desc) tablespace tbs_user_default;
--函数索引目前支持to_char、upper
create index idx_tbl_fun_01 on tb1(upper(col_number1) desc) tablespace tbs_user_default;
create index idx_tbl_fun_02 on tb1(upper(col_timestamp3) desc) tablespace tbs_user_default;
--创建comment
comment on column tb1.col_tinyint IS 'I am ok!!I am ok!!I am ok!!I am ok!!I am ok!!I am ok!!I am ok!!I am ok!!I am ok!!I am ok!!';