...
DELETE FROM gs_client_global_keys_args;
DELETE FROM gs_column_keys_args;
...
SELECT * from int_type where col1 = 555;
...
UPDATE int_type SET col1 = -200 where col1 = -20;

SELECT * from int_type order by id;

DROP TABLE int_type;

create table IF NOT EXISTS serial_type(
c1 int, 
