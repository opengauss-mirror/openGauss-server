...
SELECT '' AS five, q1 AS plus, -q1 AS minuz FROM INT8_TBL ORDER BY q1;

SELECT '' AS five, q1, q2, q1 + q2 AS plus FROM INT8_TBL ORDER BY q1,q2;
SELECT '' AS five, q1, q2, q1 - q2 AS minuz FROM INT8_TBL ORDER BY q1,q2;
...
-- divide zero
SELECT (0)::int8 / (-2)::int2;
SELECT (0)::int8 / (-2)::int4;
SELECT (0)::int8 / (-2)::int8;
