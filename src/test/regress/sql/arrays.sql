...
create  table arrays_t1 (f1 int8_tbl[]);
insert into arrays_t1 (f1[5].q1) values(42);
select * from arrays_t1;
update arrays_t1 set f1[5].q2 = 43;
select * from arrays_t1;
DROP TABLE arrtest1 CASCADE;
DROP TABLE arrtest2 CASCADE;
DROP TABLE arrtest_f CASCADE;
DROP TABLE arrtest_i CASCADE;
DROP table arr_tbl CASCADE;
DROP TABLE arraggtest CASCADE;
DROP table arrays_t1 CASCADE;
