...
-- EXTRACT(TIEMZONE_XXX)基本测试
SET TIMEZONE TO 'Asia/Beijing';
SELECT EXTRACT(TIMEZONE_HOUR FROM TIMESTAMPTZ '2024-09-02 10:30:00 America/New_York');
SELECT EXTRACT(TIMEZONE_HOUR FROM TIMESTAMP '2024-09-02 10:30:00');
SELECT EXTRACT(TIMEZONE_HOUR FROM INTERVAL '10 hours');
SELECT EXTRACT(TIMEZONE_HOUR FROM DATE '2024-09-02');
SELECT EXTRACT(TIMEZONE_HOUR FROM TIME '10:30:00');
SELECT EXTRACT(TIMEZONE_HOUR FROM TIMETZ '10:30:00+03');

SELECT EXTRACT(TIMEZONE_MINUTE FROM TIMESTAMPTZ '2024-09-02 10:30:00 America/Los_Angeles');
SELECT EXTRACT(TIMEZONE_MINUTE FROM TIMESTAMP '2024-09-02 10:30:00');
SELECT EXTRACT(TIMEZONE_MINUTE FROM INTERVAL '10 hours');
SELECT EXTRACT(TIMEZONE_MINUTE FROM DATE '2024-09-02');
SELECT EXTRACT(TIMEZONE_MINUTE FROM TIME '10:30:00');
SELECT EXTRACT(TIMEZONE_MINUTE FROM TIMETZ '10:30:00+03');

SELECT EXTRACT(TIMEZONE_REGION FROM TIMESTAMPTZ '2024-09-02 10:30:00 Europe/London');
SELECT EXTRACT(TIMEZONE_REGION FROM TIMESTAMP '2024-09-02 10:30:00');
SELECT EXTRACT(TIMEZONE_REGION FROM INTERVAL '10 hours');
SELECT EXTRACT(TIMEZONE_REGION FROM DATE '2024-09-02');
SELECT EXTRACT(TIMEZONE_REGION FROM TIME '10:30:00');
SELECT EXTRACT(TIMEZONE_REGION FROM TIMETZ '10:30:00+03');

SELECT EXTRACT(TIMEZONE_ABBR FROM TIMESTAMPTZ '2024-09-02 10:30:00 Asia/Tokyo');
SELECT EXTRACT(TIMEZONE_ABBR FROM TIMESTAMP '2024-09-02 10:30:00');
SELECT EXTRACT(TIMEZONE_ABBR FROM INTERVAL '10 hours');
SELECT EXTRACT(TIMEZONE_ABBR FROM DATE '2024-09-02');
SELECT EXTRACT(TIMEZONE_ABBR FROM TIME '10:30:00');
SELECT EXTRACT(TIMEZONE_ABBR FROM TIMETZ '10:30:00+03');
...
-- EXTRACT(TIEMZONE_XXX)边界条件测试
SET TIMEZONE TO 'Asia/Beijing';
SELECT EXTRACT(TIMEZONE_HOUR FROM 'infinity'::timestamptz);
SELECT EXTRACT(TIMEZONE_MINUTE FROM 'infinity'::timestamptz);
SELECT EXTRACT(TIMEZONE_REGION FROM 'infinity'::timestamptz);
SELECT EXTRACT(TIMEZONE_ABBR FROM 'infinity'::timestamptz);

SELECT EXTRACT(TIMEZONE_HOUR FROM 'invalid_timestamp');
SELECT EXTRACT(TIMEZONE_MINUTE FROM 'invalid_timestamp');
...
SELECT EXTRACT(TIMEZONE_ABBR FROM TIMESTAMP WITH TIME ZONE '2024-09-02 10:30:00+320');