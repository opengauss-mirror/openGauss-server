...
CREATE FOREIGN TABLE BOOLTBL1 (f1 bool) SERVER mot_server ;
...
CREATE FOREIGN TABLE BOOLTBL2 (f1 bool) SERVER mot_server ;
...
DROP FOREIGN TABLE  BOOLTBL1;

DROP FOREIGN TABLE  BOOLTBL2;
