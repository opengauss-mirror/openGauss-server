...
CREATE FOREIGN TABLE fract_only (id int, val numeric(4,4)) SERVER mot_server ;
...
CREATE FOREIGN TABLE ceil_floor_round (a numeric) SERVER mot_server ;
...
-- normal operation
CREATE FOREIGN TABLE width_bucket_test (operand_num numeric, operand_f8 float8) SERVER mot_server ;
