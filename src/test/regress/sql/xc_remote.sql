...
CREATE TABLE rel_rep (a int, b int);
ALTER TABLE rel_rep ADD PRIMARY KEY(a, b);
CREATE TABLE rel_hash (a int, b int);
CREATE TABLE rel_rr (a int, b int);
...
CREATE TABLE rel_rep (a int, b timestamp DEFAULT NULL, c boolean DEFAULT NULL);
ALTER TABLE rel_rep ADD PRIMARY KEY(a);
...
CREATE TABLE rel_rr (a int, b timestamp DEFAULT NULL, c boolean DEFAULT NULL);
...
CREATE TABLE rel_hash (a int, b timestamp DEFAULT now(), c boolean DEFAULT false);
