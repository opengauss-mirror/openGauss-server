...
DROP SCHEMA IF EXISTS index_pcr_ustore_smp_back CASCADE;
CREATE SCHEMA index_pcr_ustore_smp_back;
SET CURRENT_SCHEMA TO index_pcr_ustore_smp_back;
...
DROP SCHEMA index_pcr_ustore_smp_back CASCADE;