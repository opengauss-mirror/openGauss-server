DROP SCHEMA IF EXISTS index_astore_smp_back CASCADE;
CREATE SCHEMA index_astore_smp_back;
SET CURRENT_SCHEMA TO index_astore_smp_back;
...
DROP SCHEMA index_astore_smp_back CASCADE;