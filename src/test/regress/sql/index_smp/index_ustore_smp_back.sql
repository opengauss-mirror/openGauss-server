DROP SCHEMA IF EXISTS index_ustore_smp_back CASCADE;
CREATE SCHEMA index_ustore_smp_back;
SET CURRENT_SCHEMA TO index_ustore_smp_back;
...
DROP SCHEMA index_ustore_smp_back CASCADE;