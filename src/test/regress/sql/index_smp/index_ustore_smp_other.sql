DROP SCHEMA IF EXISTS index_ustore_smp_other CASCADE;
CREATE SCHEMA index_ustore_smp_other;
SET CURRENT_SCHEMA TO index_ustore_smp_other;
...
DROP SCHEMA index_ustore_smp_other CASCADE;