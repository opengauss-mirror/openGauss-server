DROP SCHEMA IF EXISTS index_astore_smp_other CASCADE;
CREATE SCHEMA index_astore_smp_other;
SET CURRENT_SCHEMA TO index_astore_smp_other;
...
DROP SCHEMA index_astore_smp_other CASCADE;