-- event trigger is only supported in PG compatability, test A、B、C compatability, all case should fail.
...
alter event trigger regress_event_trigger rename to test_rename;
alter event trigger regress_event_trigger owner to test_user;
drop event trigger regress_event_trigger;
comment on event trigger regress_event_trigger is 'comment';
...
drop event trigger regress_event_trigger;
comment on event trigger regress_event_trigger is 'comment';
create database test_event_trigger_C dbcompatibility 'C';
\c test_event_trigger_C
...
DROP DATABASE test_event_trigger_C;
