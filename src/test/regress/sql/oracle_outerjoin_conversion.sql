...
----with out Identifier------
create table t1(a1 int, b1 int, c1 int) distribute by hash(a1);
create table t2(a2 int, b2 int, c2 int) distribute by hash(a2);
...
create table t15 (like t11 INCLUDING all);
...
explain (verbose on, costs off, analyze on, timing off, detail off, NUM_buffers off, cpu off)
select * from (select t11.c1 a from t11 left join t12 on t11.c1 = t12.c2) inner join t13 on (a = c3) order by 1,2,3,4;
