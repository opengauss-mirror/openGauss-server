...
CREATE TABLE merge_privs_target (id integer, balance integer);
CREATE TABLE merge_privs_source (id integer, delta integer);

ALTER TABLE merge_privs_target OWNER TO merge_privs;
ALTER TABLE merge_privs_source OWNER TO merge_privs;

CREATE TABLE merge_privs_source2 (id integer, delta integer);
CREATE TABLE merge_privs_target2 (id integer, balance integer); 
...
-- clean up
RESET SESSION AUTHORIZATION;
DROP TABLE merge_privs_target;
DROP TABLE merge_privs_target2;
DROP TABLE merge_privs_source;
DROP TABLE merge_privs_source2;
