...
set enable_trigger_shipping = off;
explain performance update test_trigger_src_tbl set id3=1000 where id3=100;
set enable_trigger_shipping = on;
explain performance update test_trigger_src_tbl set id3=2000 where id3=200;
select * from test_trigger_src_tbl order by id1;
select * from test_trigger_des_tbl order by id1;

set enable_trigger_shipping = off;
explain performance delete from test_trigger_src_tbl where id2=100;
set enable_trigger_shipping = on;
explain performance delete from test_trigger_src_tbl where id2=200;
select * from test_trigger_src_tbl order by id1;
select * from test_trigger_des_tbl order by id1;
