...
select count(*) from pg_job where log_user = priv_user and priv_user = 'scheduler_user';
...
select count(*) from pg_job where log_user = priv_user and priv_user = 'scheduler_new_user';
