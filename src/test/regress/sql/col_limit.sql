create schema vector_distribute_limit;
set current_schema = vector_distribute_limit;

create table row_table_01 (c1 int, c2 int, c3 int) ;
create table row_table_02 (c1 int, c2 int, c3 int) ;
...
insert into row_table_02 values (11, 11, 31);
insert into row_table_02 values (12, 12, 32);
insert into row_table_02 values (13, 13, 33);
insert into row_table_02 values (14, 14, 34);
insert into row_table_02 values (15, 15, 35);
insert into row_table_02 values (16, 16, 36);

create table limit_table_01 (c1 int, c2 int, c3 int) with (orientation = column) ;
create table limit_table_02 (c1 int, c2 int, c3 int) with (orientation = column) ;

insert into limit_table_01 select * from row_table_01;
insert into limit_table_02 select * from row_table_02;
...
select a.c1, b.c2, b.c3 from (select c1 from limit_table_01 order by c1 limit 2) a , limit_table_02 b where a.c1=b.c2 order by a.c1;
select a.c1, b.c2, b.c3 from (select c1 from limit_table_01 order by c1 offset 1) a , limit_table_02 b where a.c1=b.c2 order by a.c1;
...
drop schema vector_distribute_limit cascade;
