/*
################################################################################
# TESTCASE NAME : skew_statistic_data_type_04.py 
# COMPONENT(S)  : 测试多分布列使用多列统计信息
...
--S2.收集统计信息
analyze skew_type(st_int1, st_int2, st_int4, st_int8, st_num, st_char, st_varchar, st_text, st_date, st_time, st_timez, st_timestamp, st_timestampz, st_smalldatetime, st_interval);
...
--I8.倾斜值为time with time zone, timestamp
--S1.执行计划
...
--I9.倾斜值为timestamp with time zone, smalldatetime
--S1.执行计划
...
--I10.倾斜值为interval, smalldatetime
--S1.执行计划
