...
create table ch_tab(a char);
insert into ch_tab values('a');
select hashchar('a');


create table nm_tab(a name);
insert into nm_tab values('abbas');
select hashname('abbas');

create table nu_tab(a numeric(10,5));
...
create table vc_tab(a varchar(255));
...
create table bpc_tab(a char(35));
...
create table timtz_tab(a time with time zone);
...
create table ts_tab(a timestamp);
...
create table in_tab(a interval);
...
create table atim_tab(a abstime);
...
create table rtim_tab(a reltime);
...
create table tstz_tab(a timestamp with time zone);
...
create table tstz_tab_h(a timestamp with time zone);
...
create table my_rr_tab(a integer, b varchar(100));
