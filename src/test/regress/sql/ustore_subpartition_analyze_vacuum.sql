-- prepare
DROP SCHEMA ustore_subpartition_analyze_vacuum CASCADE;
CREATE SCHEMA ustore_subpartition_analyze_vacuum;
SET CURRENT_SCHEMA TO ustore_subpartition_analyze_vacuum;
