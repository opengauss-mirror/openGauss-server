create schema full_join_on_true_row_3;
set current_schema='full_join_on_true_row_3';
...
create table full_join_t1 (a int, b int, c int) distribute by hash(a) ;
drop table if exists full_join_t2;
create table full_join_t2 (a int, b float, c int) distribute by hash(a) ;
...
drop schema full_join_on_true_row_3 CASCADE;
