DROP SCHEMA segment_subpartition_add_drop_partition CASCADE;
CREATE SCHEMA segment_subpartition_add_drop_partition;
SET CURRENT_SCHEMA TO segment_subpartition_add_drop_partition;
