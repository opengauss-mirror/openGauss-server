...
create table  vector_material_engine_002.fvt_distribute_query_tables_01(
        ...
        w_zip   char(9),
        w_id    integer , partial cluster key(w_name)) with (orientation=column) 
...
create table  vector_material_engine_002.fvt_distribute_query_tables_04(
        w_id    integer,
        w_name  varchar(20),
        w_zip   integer, partial cluster key(w_id)) with (orientation=column) ;
...
create table  vector_material_engine_002.fvt_distribute_query_tables_05(
        ...
        c_zip   char(9),
        c_d_id  integer,
      c_id    integer, partial cluster key(c_w_id,c_id,c_d_id)) with (orientation=column) 
...
drop table if exists fvt_distribute_query_tables_01  cascade;
drop table if exists  fvt_distribute_query_tables_02 cascade;
drop table if exists  fvt_distribute_query_tables_03 cascade;
drop table if exists  fvt_distribute_query_tables_04 cascade;
drop table if exists  fvt_distribute_query_tables_05 cascade;
drop table if exists  fvt_distribute_query_tables_06 cascade;
drop table if exists  fvt_distribute_query_tables_07 cascade;
drop schema if exists  vector_material_engine_002    cascade;
