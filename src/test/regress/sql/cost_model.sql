...
insert into test_bitmap_cost_with_lossy select id,(random()*200)::int,'sssssssssssssssssssssssssssssssssssss' from (select generate_series(1,300000) id) test_bitmap_cost_with_lossy;
