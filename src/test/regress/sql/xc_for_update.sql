...
create table rep(a int,b int,c int);
...
explain (costs off, verbose on, nodes off) select * from lock_partition_001, lock_partition_002, lock_partition_003 order by lock_partition_003.val2 for update of lock_partition_001;
