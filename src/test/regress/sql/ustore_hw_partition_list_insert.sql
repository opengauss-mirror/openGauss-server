...
insert into test_partition_for_null_list select * from test_partition_for_null_list;
select * from test_partition_for_null_list order by a;
...
select count(*) from select_list_partition_table_000_3;
...
INSERT INTO select_partition_table_000_3 VALUES('I','IJK','IJKLMNO','i','ijk','ijklmno',100,999999,99,9.9,9.99,9.999,'2000-09-09','2000-09-09 09:09:09','2000-09-09 09:09:09+09');
...
insert into test_select_list_partition values(3,3);
insert into test_select_list_partition values(7,5);
insert into test_select_list_partition values(7,6);
select count(*) from test_select_list_partition;
