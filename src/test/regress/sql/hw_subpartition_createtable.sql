...
CREATE SCHEMA subpartition_createtable;
SET CURRENT_SCHEMA TO subpartition_createtable;
...
create table range_range_copy as select * from range_range subpartition(p_201901_a) where month_code in(201902,201903);
