...
CREATE ROLE test_pwd_role IDENTIFIED BY "Ttest@123";
drop role test_pwd_role;
CREATE ROLE test_pwd_role password "Ttest@123";
drop role test_pwd_role;
CREATE user test_pwd_user IDENTIFIED BY "Ttest@123";
drop user test_pwd_user;
CREATE user test_pwd_user password "Ttest@123";
drop user test_pwd_user;
