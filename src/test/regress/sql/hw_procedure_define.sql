...
-- Test Privilage
-------------------------------------------------------
--CREATE USER  USER1 PASSWORD 'ttest@123';
...
CREATE USER SCHEMA_AUTHORITY_USER_005 PASSWORD 'Ttest@123';
GRANT CREATE ON SCHEMA FVT_OBJ_DEFINE TO SCHEMA_AUTHORITY_USER_005;
SET ROLE SCHEMA_AUTHORITY_USER_005 PASSWORD 'Ttest@123';
...
DECLARE
BEGIN
CREATE USER U_PRO_NO_EXP_001_1 PASSWORD 'Ttest_234';
