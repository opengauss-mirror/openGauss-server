...
DROP SCHEMA subpartition_scan CASCADE;
CREATE SCHEMA subpartition_scan;
SET CURRENT_SCHEMA TO subpartition_scan;
...
create table range_range_jade(jid int,jn int,name varchar2)partition by range (jid) subpartition by range(jn)
(
...
explain (format yaml, costs off)  select * from list_range_02 where col_2 in
          (select col_1 from list_range_02 subpartition(p_list_2_subpartdefault1)
           where col_1 >10 and col_1 <100) and col_1 +col_2 =50 and col_2 in  (100,200,300 );
explain (format json, costs off)  select * from list_range_02 where col_2 in
          (select col_1 from list_range_02 subpartition(p_list_2_subpartdefault1)
           where col_1 >10 and col_1 <100) and col_1 +col_2 =50 and col_2 in  (100,200,300 );
drop table list_range_02;
...
explain (costs off) select * from list_list_02 where col_1=(select max(1) from list_list_02);
