...
select a.relname,a.parttype,a.reloptions from pg_partition a, pg_class b where a.parentid = b.oid and b.relname = 'gpi_test_invalid_part' order by b.relname;
...
select a.relname,a.parttype,a.reloptions from pg_partition a, pg_class b where a.parentid = b.oid and b.relname = 'gpi_test_invalid_part' and a.reloptions[3] like '%wait_clean_gpi=y%' order by b.relname;
...
select a.relname,a.parttype,a.reloptions from pg_partition a, pg_class b where a.parttype = 'p' and a.relname = 'p6' and b.relname = 'gpi_test_invalid_part' and a.reloptions[3] like '%wait_clean_gpi=y%' order by b.relname;
commit;
...
select a.relname,a.parttype,a.reloptions from pg_partition a, pg_class b where a.parttype = 'p' and (a.relname = 'p7' or a.relname = 'p8') and b.relname = 'gpi_test_invalid_part' and a.reloptions[3] like '%wait_clean_gpi=y%' order by b.relname;
commit;
...
select a.relname,a.parttype,a.reloptions from pg_partition a, pg_class b  where a.parttype = 'p' and a.relname = 'p9' and a.reloptions[3] like '%wait_clean_gpi=y%' and b.relname = 'gpi_test_invalid_part' order by b.relname;
...
-- gpi_test_invalid_part reloptions have "wait_clean_gpi=y"
select a.relname,a.parttype,a.reloptions from pg_partition a, pg_class b where a.reloptions[3] like '%wait_clean_gpi=y%' and b.relname = 'gpi_test_invalid_part' order by b.relname;
...
select a.relname,a.parttype,a.reloptions from pg_partition a, pg_class b where a.parentid = b.oid and b.relname = 'gpi_test_create_invalid' and a.reloptions[3] like '%wait_clean_gpi=y%' order by b.relname;
...
--p9 reloptions have "wait_clean_gpi=y"
select a.relname,a.parttype,a.reloptions from pg_partition a, pg_class b where a.parttype = 'p' and a.relname = 'p6' and a.reloptions[3] like '%wait_clean_gpi=y%' and b.relname = 'gpi_test_create_invalid' order by b.relname;
rollback to s1;
commit;
