...
SELECT * FROM char_to_num_col ORDER BY 1, 2, 3, 4;
...
-- empty string test
CREATE TABLE char_to_num_00 ( a int, b varchar(10) ) with ( orientation = column );
...
INSERT INTO char_to_num_01 SELECT * FROM char_to_num_01;
INSERT INTO char_to_num_01 SELECT * FROM char_to_num_01;
CREATE TABLE char_to_num_02 ( a int , b char(11) ) with ( orientation = column );
...
-- assert failed
CREATE TABLE char_to_num_03 (id int, a char(22) ) with (orientation = column );
...
-- uint64 overflow
CREATE TABLE char_to_num_04 (id int, a varchar(22) ) with (orientation = column );
