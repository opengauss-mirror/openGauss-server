...
SELECT '' AS to_char_27, to_char('100'::numeric, 'f"ool\\"999');
...
SELECT '' AS to_number_15, to_number('123456','999G999');
SELECT '' AS to_number_16, to_number('$1234.56','L9,999.99');
SELECT '' AS to_number_17, to_number('1234.56','L99,999.99');
SELECT '' AS to_number_18, to_number('345,50','99,999');
