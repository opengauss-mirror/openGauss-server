...
create table tab_segment_off1(a int) with(segment=false);
create table tab_segment_off2(a int) with(segment=f);
create table tab_segment_off3(a int) with(segment=0);
create table tab_segment_off4(a int) with(segment=no);
create table tab_segment_off5(a int) with(segment=n);
