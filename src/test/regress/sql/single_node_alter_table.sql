...
-- test alter table parent / child
create table parent (a int);
create table child (b varchar(255)) inherits (parent);
alter table parent modify (a not null enable);
insert into parent values (NULL);
insert into child (a, b) values (NULL, 'foo');
alter table parent modify(a null);
insert into parent values (NULL);
insert into child (a, b) values (NULL, 'foo');
alter table only parent modify (a not null enable);
alter table child modify (a not null enable);
delete from parent;
alter table only parent modify (a not null enable);
insert into parent values (NULL);
alter table child modify (a not null enable);
