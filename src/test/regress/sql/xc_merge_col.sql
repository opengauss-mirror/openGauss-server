...
-- initial
CREATE SCHEMA xc_mergeinto_col;
SET current_schema = xc_mergeinto_col;
...
--
-- PGXC mode(MERGE cannot be pushed down), column table
--
...
-- clean up
DROP SCHEMA xc_mergeinto_col CASCADE;
