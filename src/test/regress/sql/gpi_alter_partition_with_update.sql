...
ALTER TABLE alter_table drop partition p1 update global index;
...
ALTER TABLE alter_table EXCHANGE PARTITION FOR(2500) WITH TABLE exchange_table update global index;
