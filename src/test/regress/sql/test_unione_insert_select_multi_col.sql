...
create schema test_unione_insert_update_col;
set current_schema='test_unione_insert_update_col';
...
-- update
update integer_table set c3=10;
update integer_table set c9=100 where c2=1;
update v_integer_table set c3=10;
update v_integer_table set c9=100 where c2=1;

update decimal_table set c1=19.99999;
update decimal_table set c2=135 where c4 < 200;
update v_decimal_table set c1=19.99999;
update v_decimal_table set c2=135 where c4 < 200;

update numeric_table set c1=135.2468;
update numeric_table set c4=999 where c3 < 200;
update v_numeric_table set c1=135.2468;
update v_numeric_table set c4=999 where c3 < 200;

update mix_table set c4=20200904;
update mix_table set c2=false where c1>1000::money;
update v_mix_table set c4=20200904;
update v_mix_table set c2=false where c1>1000::money;

update network_table set c1='192.192.0.0/20';
update network_table set c1='192.192.0.0/15' where c2='192.169.1.226/12';
update v_network_table set c1='192.192.0.0/20';
update v_network_table set c1='192.192.0.0/15' where c2='192.169.1.226/12';

update bit_table set c1=B'1';
update bit_table set c1=B'0' where c2=B'10';
update v_bit_table set c1=B'1';
update v_bit_table set c1=B'0' where c2=B'10';

update text_search_table set c1=' a:2 s:2 d g';
update text_search_table set c1=' a:1 s:1 d g' where c2='1|2|4|5|6';
update v_text_search_table set c1=' a:2 s:2 d g';
update v_text_search_table set c1=' a:1 s:1 d g' where c2='1|2|4|5|6';

update geometric_table set c1='(0.1,0.1)' where c7='<(500,500),500>';
update v_geometric_table set c1='(0.1,0.1)' where c7='<(500,500),500>';

update time_table set c2='12:12:12';
update time_table set c4='12:12:12';
update v_time_table set c2='12:12:12';
update v_time_table set c4='12:12:12';

update character_table set c2='hi';
update character_table set c12='hi' where c1='a';
update v_character_table set c2='hi';
update v_character_table set c12='hi' where c1='a';

update t1 set c7='CCCCC';
update t1 set c4='DEADBEE' where c7='AAAAA';
update t1 set c5.col_bool=true;
update v_t1 set c7='CCCCC';
update v_t1 set c4='DEADBEE' where c7='AAAAA';
update v_t1 set c5.col_bool=true;
