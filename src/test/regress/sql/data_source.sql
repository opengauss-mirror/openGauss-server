...
\! echo $GAUSSHOME | sed 's/^.*tmp_check\/install\///g' | xargs -I{} /usr1/gauss_jenkins/jenkins/workspace/openGauss/src/test/regress/./tmp_check/install//usr1/gauss_jenkins/jenkins/workspace/openGauss/install/bin/gs_guc generate -S 456pwd -D {}/bin -o datasource
...
-- invalid option
CREATE DATA SOURCE llt_mppdb_f2 OPTIONS (url '00.00.00.00');
...
-- invalid options
ALTER DATA SOURCE llt_mppdb_31 OPTIONS (url '00.00.00.00');
SELECT srcname, srctype, srcversion, srcacl FROM PG_EXTENSION_DATA_SOURCE WHERE SRCNAME='llt_mppdb_31';
...
\! /usr1/gauss_jenkins/jenkins/workspace/openGauss/src/test/regress/./tmp_check/install//usr1/gauss_jenkins/jenkins/workspace/openGauss/install/bin/gsql -d postgres -p 8798  -U ds_user_llt_01 -W Gs@123456 -c "grant usage on data source mpp_llt_01 to ds_user_llt_02;"
\! /usr1/gauss_jenkins/jenkins/workspace/openGauss/src/test/regress/./tmp_check/install//usr1/gauss_jenkins/jenkins/workspace/openGauss/install/bin/gsql -d postgres -p 8798  -U ds_user_llt_01 -W Gs@123456 -c "alter data source mpp_llt_01 version '11.1';"
