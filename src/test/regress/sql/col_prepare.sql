...
explain (costs off, verbose on, nodes off) execute p1;
execute p1;
execute p1;

explain (costs off, verbose on, nodes off) execute p2(1);
execute p2(1);
execute p2(1);
execute p2(2);
execute p2(2);
...
explain (costs off, verbose on, nodes off) execute p3;
execute p3;

explain (costs off, verbose on, nodes off) execute p4(1);
execute p4(1);
