...
DROP TABLE cstore_update_test_d;
create table cstore_tbl_update(a1 int,a2 varchar2(100)) with(orientation = column) ;
...
create table cstore_sub_tab(t1 int,t2 varchar2(100))with(orientation = column) ;
...
create table cstore_test_tbl_b(a int, b int) with(orientation = column);
...
insert into cstore_update_row_1 values (1, generate_series(1, 240000), generate_series(1, 240000));
insert into cstore_update_row_2 values (1, 10, generate_series(1, 240000));

--- table
create table cstore_update_1 (id int, cu int, num int) with (orientation = column)  ;
create table cstore_update_2 (id int, cu int, num int) with (orientation = column)  ;

insert into cstore_update_1 select * from cstore_update_row_1;
insert into cstore_update_2 select * from cstore_update_row_2;

--- partition table
create table cstore_update_partition_1 (id int, cu int, num int) with (orientation = column)  
partition by range(num)(
partition part1 values less than(10001),
partition part2 values less than(20001),
partition part3 values less than(maxvalue)
);

create table cstore_update_partition_2 (id int, cu int, num int) with (orientation = column)  
partition by range(num)(
partition part1 values less than(10001),
partition part2 values less than(20001),
partition part3 values less than(maxvalue)
...
insert into cstore_update_partition_1 select * from cstore_update_row_1;
insert into cstore_update_partition_2 select * from cstore_update_row_2;

update cstore_update_1 set cu = cstore_update_2.num from cstore_update_2 where cstore_update_1.cu=cstore_update_2.cu;
update cstore_update_partition_1 set cu = cstore_update_partition_2.num from cstore_update_partition_2 where cstore_update_partition_1.cu=cstore_update_partition_2.cu;
...
update cstore_update_partition_1 set cu = 1;
update cstore_update_partition_1 set cu = 2;
update cstore_update_partition_1 set cu = 1;
select count(*) from cstore_update_partition_1 where cu = 1;
commit;
...
drop table cstore_update_partition_1;
drop table cstore_update_partition_2;
