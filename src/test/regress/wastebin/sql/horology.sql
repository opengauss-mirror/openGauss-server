...
SELECT '' AS "160", d.f1 AS "timestamp", t.f1 AS "interval", d.f1 - t.f1 AS minuz
  FROM TEMP_TIMESTAMP d, INTERVAL_TBL t
  WHERE isfinite(d.f1)
  ORDER BY minuz, "timestamp", "interval";
...
-- OVERLAPS parameter error
SELECT ROW (DATE '2001-02-16', DATE '2001-12-21') OVERLAPS ROW (DATE '2001-10-30', DATE '2002-10-30');
SELECT ROW (DATE '2001-02-16') OVERLAPS ROW (DATE '2001-10-30', DATE '2002-10-30');
SELECT ROW (DATE '2001-02-16', DATE '2001-12-21') OVERLAPS ROW (DATE '2001-10-30');
