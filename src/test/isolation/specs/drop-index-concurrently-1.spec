...
#
setup {	CREATE TABLE test_dc(id serial primary key, data int); }
setup { INSERT INTO test_dc(data) SELECT * FROM generate_series(1, 100); }
setup { CREATE INDEX test_dc_data ON test_dc(data); }
