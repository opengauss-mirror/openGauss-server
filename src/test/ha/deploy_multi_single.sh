...
#stop the database
./run_python.sh $scripts_dir/pgxc_multi_single.py -o

sleep 2
#init the database
./run_python.sh $scripts_dir/pgxc_multi_single.py -c 1 -d $node_num
...
sleep 2
#start the database
./run_python.sh $scripts_dir/pgxc_multi_single.py -s
