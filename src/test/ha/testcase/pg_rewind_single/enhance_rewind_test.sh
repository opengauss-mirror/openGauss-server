...
function test_3()
{
	...
	gs_guc set -D $data_dir/datanode1 -c "walsender_max_send_size=16MB"
	gs_guc set -D $data_dir/datanode1 -c "data_replicate_buffer_size=8MB"
	gs_guc set -D $data_dir/datanode1_standby -c "walsender_max_send_size=16MB"
	gs_guc set -D $data_dir/datanode1_standby -c "data_replicate_buffer_size=8MB"
	gs_guc set -D $data_dir/datanode1_dummystandby -c "walsender_max_send_size=16MB"
