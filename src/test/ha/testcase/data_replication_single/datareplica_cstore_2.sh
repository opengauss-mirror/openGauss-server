...
gsql -d $db -p $dn1_primary_port -c "set enable_data_replicate=on; copy cstore_copy_t1 from '$scripts_dir/data/cstore_copy_t1.data' delimiter '|'; copy cstore_copy_t1 from '$scripts_dir/data/cstore_copy_t1.data' delimiter '|'; checkpoint;"
