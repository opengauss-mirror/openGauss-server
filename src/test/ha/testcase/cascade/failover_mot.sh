...
function test_1()
{
  ...
  gsql -d $db -p $dn1_primary_port -c "DROP foreign TABLE if exists cstore_copy_t1; create foreign table cstore_copy_t1(c1 int2, c2 int4, c3 int8, c4 char(10), c5 varchar(12),c6 numeric(10,2));"
