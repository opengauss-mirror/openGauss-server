...
#wait until the standby started
...
#copy data(25M) to standby 1 times
gsql -d $db -p $dn1_standby_port -c "set enable_data_replicate=on; copy mpp_test1 from '$scripts_dir/data/data5';checkpoint;"
