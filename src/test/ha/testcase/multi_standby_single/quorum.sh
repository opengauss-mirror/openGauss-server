...
function test_1()
{
  ...
  #gs_guc set -D $primary_data_dir -c "application_name = 'datanode1'"
  ...
  kill_cluster
  gs_guc set -D $primary_data_dir -c "synchronous_commit = on"
  gs_guc set -D $primary_data_dir -c "synchronous_standby_names = 'ANY 1(standby1,standby2)'"
  gs_guc set -D $primary_data_dir -c "most_available_sync = off"
  ...
  kill_cluster
  gs_guc set -D $primary_data_dir -c "synchronous_commit = on"
  gs_guc set -D $primary_data_dir -c "synchronous_standby_names = 'ANY 2(standby1,standby2,standby3)'"
  gs_guc set -D $primary_data_dir -c "most_available_sync = off"
  #gs_guc set -D $primary_data_dir -c "application_name = 'datanode1'"
  start_cluster
  ...
  kill_cluster
  gs_guc set -D $primary_data_dir -c "synchronous_commit = on"
  gs_guc set -D $primary_data_dir -c "synchronous_standby_names = 'FIRST 2(standby1,standby2,standby3)'"
  gs_guc set -D $primary_data_dir -c "most_available_sync = off"
  #gs_guc set -D $primary_data_dir -c "application_name = 'datanode1'"
  start_cluster
  ...
  kill_cluster
  gs_guc set -D $primary_data_dir -c "synchronous_commit = on"
  gs_guc set -D $primary_data_dir -c "synchronous_standby_names = 'ANY 1(*)'"
  gs_guc set -D $primary_data_dir -c "most_available_sync = off"
  #gs_guc set -D $primary_data_dir -c "application_name = 'datanode1'"
  start_cluster
  ...
  kill_cluster
  gs_guc set -D $primary_data_dir -c "synchronous_commit = on"
  gs_guc set -D $primary_data_dir -c "synchronous_standby_names = 'ANY 1(standby1,standby2,standby3)'"
  gs_guc set -D $primary_data_dir -c "most_available_sync = off"
  #gs_guc set -D $primary_data_dir -c "application_name = 'datanode1'"
  start_cluster
  ...
  kill_cluster
  gs_guc set -D $primary_data_dir -c "synchronous_commit = on"
  gs_guc set -D $primary_data_dir -c "synchronous_standby_names = 'FIRST 1(*)'"
  gs_guc set -D $primary_data_dir -c "most_available_sync = off"
  #gs_guc set -D $primary_data_dir -c "application_name = 'datanode1'"
  #gs_guc set -D $standby1_data_dir -c "application_name = 'standby1'"
  #gs_guc set -D $standby2_data_dir -c "application_name = 'standby2'"
  start_cluster
  ...
  #kill_cluster
  #gs_guc set -D $primary_data_dir -c "synchronous_commit = on"
  #gs_guc set -D $primary_data_dir -c "synchronous_standby_names = 'ANY (standby1)'"
  #gs_guc set -D $primary_data_dir -c "most_available_sync = off"
  #gs_guc set -D $primary_data_dir -c "application_name = 'datanode1'"
  #gs_guc set -D $standby_data_dir -c "application_name = 'standby1'"
  #gs_guc set -D $standby2_data_dir -c "application_name = 'standby2'"
  #gs_guc set -D $standby3_data_dir -c "application_name = 'standby3'"
  #start_cluster
  ...
  #kill_cluster
  #gs_guc set -D $primary_data_dir -c "synchronous_commit = on"
  #gs_guc set -D $primary_data_dir -c "synchronous_standby_names = 'FIRST (standby1)'"
  #gs_guc set -D $primary_data_dir -c "most_available_sync = off"
  #gs_guc set -D $primary_data_dir -c "application_name = 'datanode1'"
  #gs_guc set -D $standby_data_dir -c "application_name = 'standby1'"
  #gs_guc set -D $standby2_data_dir -c "application_name = 'standby2'"
