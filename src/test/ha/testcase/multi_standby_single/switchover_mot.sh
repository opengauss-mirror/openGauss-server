...
function test_1()
{
  ...
  #create table
  gsql -d $db -p $dn1_primary_port -c "DROP FOREIGN TABLE if exists mpp_test1; CREATE FOREIGN TABLE mpp_test1(id INT,name VARCHAR(15) NOT NULL) SERVER mot_server;"
