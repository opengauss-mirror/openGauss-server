#!/bin/sh
# deploy primary-standby-cascade_standby
#           1       1      node_num - 1
...
#stop the database
./run_python.sh $scripts_dir/pgxc_multi_cascade_mot.py -o

sleep 2
#init the database
./run_python.sh $scripts_dir/pgxc_multi_cascade_mot.py -c 1 -d $node_num
...
sleep 2
#start the database
./run_python.sh $scripts_dir/pgxc_multi_cascade_mot.py -s
