...
#stop the database
python $scripts_dir/pgxc_multi_cascade_mot.py -o

sleep 2
#init the database
python $scripts_dir/pgxc_multi_cascade_mot.py -c 1 -d $node_num
...
sleep 2
#start the database
python $scripts_dir/pgxc_multi_cascade_mot.py -s
