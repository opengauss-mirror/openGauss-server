...
--ALTER FUNCTION functest_F_3(int) COST  2;

ALTER FUNCTION functest_F_3(int) set query_dop to 2;
ALTER FUNCTION functest_F_3(int) set work_mem to '2MB';
ALTER FUNCTION functest_F_3(int) RESET work_mem;
ALTER FUNCTION functest_F_3(int) RESET ALL;

CREATE FUNCTION select3 () RETURNS setof int LANGUAGE SQL
AS 'select generate_series(1, 10);';
ALTER FUNCTION select3() ROWS  1;
ALTER FUNCTION select3() ROWS  33.3;
