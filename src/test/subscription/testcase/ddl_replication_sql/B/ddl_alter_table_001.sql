...
ALTER TABLE range_sales SPLIT PARTITION time_default 
INTO (PARTITION time_2013 VALUES LESS THAN ('2014-01-01'), 
    PARTITION time_2014 VALUES LESS THAN ('2015-01-01'), 
    PARTITION time_default_temp VALUES LESS THAN (MAXVALUE));
...
create table unit_varchar(a1 varchar default '1', a2 varchar(2), a3 varchar(2 byte) default 'ye', a4 varchar(2 character) default '���', a5 varchar(2 char) default 'Ĭ��');
create table unit_varchar2(a1 varchar2 default '1', a2 varchar2(2) default 'ha', a3 varchar2(2 byte), a4 varchar2(2 character) default '���', a5 varchar2(2 char) default 'Ĭ��');
create table unit_char(a1 char default '1', a2 char(2) default 'ha', a3 char(2 byte) default 'ye', a4 char(2 character), a5 char(2 char) default 'Ĭ��');
create table unit_nchar(a1 nchar default '1', a2 nchar(2) default 'ha', a3 nchar(2) default 'ye', a4 nchar(2) default '���', a5 nchar(2));
create table unit_nvarchar2(a1 nvarchar2 default '1', a2 nvarchar2(2) default 'ha', a3 nvarchar2(2) default 'ye', a4 nvarchar2(2) default '���', a5 nvarchar2(2));

insert into unit_varchar (a1) values ('1111111111123���մ�����11111111111111111111111111111111�������մ�ʵ��ʵ1');
insert into unit_varchar (a2) values ('12    ');
-- exceed
insert into unit_varchar (a2) values ('��');
insert into unit_varchar (a3) values ('12    ');
-- exceed
insert into unit_varchar (a3) values ('��');
insert into unit_varchar (a4) values ('��2    ');
-- exceed
insert into unit_varchar (a4) values ('��23    ');
-- exceed
insert into unit_varchar (a4) values ('223    ');
insert into unit_varchar (a5) values ('��2    ');
-- exceed
insert into unit_varchar (a5) values ('��23    ');
-- exceed
insert into unit_varchar (a5) values ('223    ');
-- exceed
update unit_varchar set a2='��  ';
update unit_varchar set a3='��a   ';
-- exceed
update unit_varchar set a5='������';
update unit_varchar set a5='����';
select * from unit_varchar;

insert into unit_varchar2 (a1) values ('��111111111123���մ�����11111111111111111111111111111111�������մ�ʵ��ʵ1');
insert into unit_varchar2 (a2) values ('12    ');
-- exceed
insert into unit_varchar2 (a2) values ('��');
insert into unit_varchar2 (a3) values ('12    ');
-- exceed
insert into unit_varchar2 (a3) values ('��');
insert into unit_varchar2 (a4) values ('��2    ');
-- exceed
insert into unit_varchar2 (a4) values ('��23    ');
-- exceed
insert into unit_varchar2 (a4) values ('223    ');
insert into unit_varchar2 (a5) values ('��2    ');
-- exceed
insert into unit_varchar2 (a5) values ('��23    ');
-- exceed
...
insert into unit_varchar2 (a2) values ('һ  ');
alter table unit_varchar2 modify column a3 varchar2(2 char) default '�ں�';
-- exceed
insert into unit_varchar2 (a2) values ('һe');
insert into unit_varchar2 (a1) values(default);
select * from unit_varchar2;

-- exceed
insert into unit_char (a1) values ('1111111111123���մ�����11111111111111111111111111111111�������մ�ʵ��ʵ1');
-- exceed
insert into unit_nchar (a1) values ('�� ');
insert into unit_nchar (a1) values ('1 ');
insert into unit_char (a2) values ('12    ');
-- exceed
insert into unit_char (a2) values ('��');
insert into unit_char (a3) values ('12    ');
-- exceed
insert into unit_char (a3) values ('��');
insert into unit_char (a4) values ('��2    ');
-- exceed
insert into unit_char (a4) values ('��23    ');
-- exceed
insert into unit_char (a4) values ('223    ');
insert into unit_char (a5) values ('��2    ');
-- exceed
insert into unit_char (a5) values ('��23    ');
-- exceed
insert into unit_char (a5) values ('223    ');
ALTER table unit_char ADD COLUMN a6 varchar(3 char) default 'Ĭ��ֵ';
insert into unit_char (a6) values ('��1a   ');
-- exceed
insert into unit_char (a6) values ('1234');
update unit_char set a4='��';
-- execeed
update unit_char set a5='һ��3';
select * from unit_char;

-- exceed
insert into unit_nchar (a1) values ('1111111111123���մ�����11111111111111111111111111111111�������մ�ʵ��ʵ1');
insert into unit_nchar (a1) values ('�� ');
insert into unit_nchar (a2) values ('����    ');
-- exceed
insert into unit_nchar (a2) values ('123    ');
-- exceed
insert into unit_nchar (a2) values ('��');
insert into unit_nchar (a3) values ('12    ');
insert into unit_nchar (a3) values ('��');
insert into unit_nchar (a4) values ('��2    ');
-- exceed
insert into unit_nchar (a4) values ('��23    ');
-- exceed
insert into unit_nchar (a4) values ('223    ');
insert into unit_nchar (a5) values ('��2    ');
-- exceed
insert into unit_nchar (a5) values ('��23    ');
-- exceed
insert into unit_nchar (a5) values ('223    ');

-- exceed
insert into unit_nvarchar2 (a1) values ('1111111111123���մ�����11111111111111111111111111111111�������մ�ʵ��ʵ1');
insert into unit_nvarchar2 (a1) values ('�� ');
insert into unit_nvarchar2 (a2) values ('����    ');
-- exceed
insert into unit_nvarchar2 (a2) values ('123    ');
-- exceed
insert into unit_nvarchar2 (a2) values ('��');
insert into unit_nvarchar2 (a3) values ('12    ');
insert into unit_nvarchar2 (a3) values ('��');
insert into unit_nvarchar2 (a4) values ('��2    ');
insert into unit_nvarchar2 (a5) values ('��2    ');
-- exceed
insert into unit_nvarchar2 (a5) values ('��23    ');
-- exceed
