...
- 本章节仅包含shark新增语法，原openGauss的UPDATE语法未作删除和修改。原openGauss的UPDATE语法请参考章节[UPDATE](https://docs.opengauss.org/zh/docs/latest-lite/sql_reference/UPDATE.html)。
- 新增支持table_hint子句。
...
[UPDATE](https://docs.opengauss.org/zh/docs/latest-lite/sql_reference/UPDATE.html)
