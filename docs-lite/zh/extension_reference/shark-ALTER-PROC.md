...
- 本章节只包含shark新增的语法，原openGauss的语法未做删除和修改。原openGauss的ALTER PROCEDURE语法请参考章节[ALTER PROCEDURE](https://docs.opengauss.org/zh/docs/latest-lite/sql_reference/alter_procedure.html)。
...
[ALTER PROCEDURE](https://docs.opengauss.org/zh/docs/latest-lite/sql_reference/alter_procedure.html)
