...
- 本章节只包含shark新增的语法，原openGauss的语法未做删除和修改。原openGauss的DROP PROCEDURE语法请参考章节[DROP PROCEDURE](https://docs.opengauss.org/zh/docs/latest-lite/sql_reference/drop_procedure.html)。
...
[DROP PROCEDURE](https://docs.opengauss.org/zh/docs/latest-lite/sql_reference/drop_procedure.html)
