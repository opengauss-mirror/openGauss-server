...
<refentry id="app-pg-ctl">
 ...
 <refsect1 id="app-pg-ctl-description">
  ...
  <para>
   ...
   backend server (<xref linkend="app-gaussdb">), or displaying the
  ...
  <para>
   ...
   like <application>rotatelogs</>; otherwise <command>gaussdb</command>
  ...
  <para>
   ...
   by a start.  This allows changing the <command>gaussdb</command>
   command-line options.
  </para>

  <para>
   <option>reload</option> mode simply sends the
   <command>gaussdb</command> process a <systemitem>SIGHUP</>
  ...
  <title>Options</title>
    ...
    <variablelist>
     ...
     <varlistentry>
      ...
      <listitem>
       <para>
        ...
        <command>gaussdb</command> command.
       </para>
       <para>
     ...
     <varlistentry>
      ...
      <listitem>
       <para>
        Specifies the location of the <filename>gaussdb</filename>
        executable.  By default the <filename>gaussdb</filename> executable is taken from the same
        directory as <command>gs_ctl</command>, or failing that, the hard-wired
        installation directory.  It is not necessary to use this
        option unless you are doing something unusual and get errors
        that the <filename>gaussdb</filename> executable was not found.
       </para>
 ...
 <refsect1>
  ...
  <para>
   For additional server variables, see <xref linkend="app-gaussdb">.
   ...
   <varlistentry>
    ...
    <listitem>
     <para>If this file exists in the data directory,
      ...
      <application>gaussdb</application>, unless overridden 
...
Command line was:
/usr/local/pgsql/bin/gaussdb '-D' '/usr/local/pgsql/data' '-p' '5433' '-B' '128'
</computeroutput>
</screen>
 ...
 <refsect1>
  ...
  <simplelist type="inline">
   ...
   <member><xref linkend="app-gaussdb"></member>
  </simplelist>
 </refsect1>
